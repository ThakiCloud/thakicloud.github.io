...
ebook_pages: 21
audiobook: "https://drive.google.com/file/d/1ycpNhfwGEFTSXovVunz3z-D3SpswXMDY/view"
...
![Illustration of the core idea of Building an AI-Native CI/CD Pipeline as a Solo Developer](/assets/images/ai-native-cicd-one-person-team-hero.webp)
...
<!-- nlm-visual -->
![Key-concept summary infographic 1](/assets/images/posts/news/ai-native-cicd-one-person-team/en/nlm-infographic-1.webp)
...
<!-- nlm-visual -->
![Key-concept summary infographic 2](/assets/images/posts/news/ai-native-cicd-one-person-team/en/nlm-infographic-2.webp)
*Infographic generated by NotebookLM from the sources.*

## References

- [GitHub Actions workflow syntax (needs, runs-on)](https://docs.github.com/en/actions/writing-workflows/workflow-syntax-for-github-actions)
- [GitHub Actions billing and free usage](https://docs.github.com/en/billing/concepts/product-billing/github-actions)
- [pytest documentation](https://docs.pytest.org/en/stable/)
- [pytest-cov configuration (cov-fail-under)](https://pytest-cov.readthedocs.io/en/latest/config.html)
