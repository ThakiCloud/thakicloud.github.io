...
toc_icon: "cog"
toc_sticky: true
canonical_url: "https://thakicloud.com/tech-blog/en/tutorials/ai-scientist-docker-ollama-automated-research-pipeline/"
lang: en
...
-->
<div class="d3-arch" data-arch-root id="omatedresearchpipelineen-1"></div>
<style>
...
<script>
  (() => {
    const SPEC = ({"title": "", "ariaLabel": "", "width": 198, "height": 1098, "legendTitle": "Legend", "hint": "Hover a node to trace its connections.", "groups": [], "nodes": [{"id": "A", "x": 24, "y": 24, "w": 142, "h": 62, "title": ["🎯 Research Idea", "Generation"]}, {"id": "B", "x": 35, "y": 164, "w": 121, "h": 62, "title": ["🔬 Experiment", "Design"]}, {"id": "C", "x": 31, "y": 304, "w": 128, "h": 62, "title": ["⚙️ Code", "Implementation"]}, {"id": "D", "x": 35, "y": 444, "w": 121, "h": 62, "title": ["🧪 Experiment", "Execution"]}, {"id": "E", "x": 35, "y": 584, "w": 120, "h": 62, "title": ["📊 Results", "Analysis"]}, {"id": "F", "x": 35, "y": 724, "w": 120, "h": 62, "title": ["📝 Paper", "Writing"]}, {"id": "G", "x": 35, "y": 864, "w": 120, "h": 62, "title": ["📋 Peer", "Review"]}, {"id": "H", "x": 35, "y": 1004, "w": 120, "h": 62, "title": ["📄 Final", "Paper"]}], "edges": [{"src": "A", "dst": "B", "kind": "data", "line": [95, 86, 95, 164]}, {"src": "B", "dst": "C", "kind": "data", "line": [95, 226, 95, 304]}, {"src": "C", "dst": "D", "kind": "data", "line": [95, 366, 95, 444]}, {"src": "D", "dst": "E", "kind": "data", "line": [95, 506, 95, 584]}, {"src": "E", "dst": "F", "kind": "data", "line": [95, 646, 95, 724]}, {"src": "F", "dst": "G", "kind": "data", "line": [95, 786, 95, 864]}, {"src": "G", "dst": "H", "kind": "data", "line": [95, 926, 95, 1004]}]});
    const ensureD3 = (cb) => {
    ...
    const bootstrap = () => {
      const container = document.getElementById('omatedresearchpipelineen-1')
        || document.querySelector('.d3-arch[data-arch-root]:not([data-mounted])');
      if (!container || (container.dataset && container.dataset.mounted === 'true')) return;
      if (container.dataset) container.dataset.mounted = 'true';

      try {
        const uid = 'omatedresearchpipelineen-1';
