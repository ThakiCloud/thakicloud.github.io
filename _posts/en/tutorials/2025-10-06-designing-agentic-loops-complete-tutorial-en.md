...
-->
<div class="d3-arch" data-arch-root id="cloopscompletetutorialen-1"></div>
<style>
...
<script>
  (() => {
    const SPEC = ({"title": "", "ariaLabel": "", "width": 263, "height": 742, "legendTitle": "Legend", "hint": "Hover a node to trace its connections.", "groups": [], "nodes": [{"id": "A", "x": 29, "y": 24, "w": 135, "h": 46, "title": "Goal Definition"}, {"id": "B", "x": 33, "y": 148, "w": 128, "h": 46, "title": "Tool Selection"}, {"id": "C", "x": 26, "y": 272, "w": 142, "h": 46, "title": "Action Execution"}, {"id": "D", "x": 82, "y": 396, "w": 149, "h": 46, "title": "Result Evaluation"}, {"id": "E", "x": 24, "y": 520, "w": 146, "h": 52, "title": "Goal Achieved?"}, {"id": "F", "x": 37, "y": 664, "w": 120, "h": 46, "title": "Success"}], "edges": [{"src": "A", "dst": "B", "kind": "data", "line": [97, 70, 97, 148]}, {"src": "B", "dst": "C", "kind": "data", "line": [97, 194, 97, 272]}, {"src": "C", "dst": "D", "kind": "data", "curve": [[119, 318], [156, 357], [156, 357], [156, 396]]}, {"src": "D", "dst": "E", "kind": "data", "curve": [[156, 442], [156, 481], [156, 481], [121, 520]]}, {"src": "E", "dst": "C", "kind": "data", "label": "No", "curve": [[73, 520], [38, 481], [38, 357], [75, 318]], "off": "50%"}, {"src": "E", "dst": "F", "kind": "data", "label": "Yes", "line": [97, 572, 97, 664], "lx": 97, "ly": 614}]});
    const ensureD3 = (cb) => {
    ...
    const bootstrap = () => {
      const container = document.getElementById('cloopscompletetutorialen-1')
        || document.querySelector('.d3-arch[data-arch-root]:not([data-mounted])');
      if (!container || (container.dataset && container.dataset.mounted === 'true')) return;
      if (container.dataset) container.dataset.mounted = 'true';

      try {
        const uid = 'cloopscompletetutorialen-1';
