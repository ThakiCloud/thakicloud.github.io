...
![Three points on the format-freedom axis](/assets/images/posts/research/format-determinism-tier-decay/fig-taxonomy-axis.webp)
...
![Cost comparison between strategy E and strategy V](/assets/images/posts/research/format-determinism-tier-decay/fig-cost-comparison.webp)
...
![Design of the 3x3 factorial measurement protocol](/assets/images/posts/research/format-determinism-tier-decay/fig-protocol-design.webp)
