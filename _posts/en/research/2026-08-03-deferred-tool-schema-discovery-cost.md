...
![Illustration of the core idea of Deferred MCP Tools: If the Agent Doesn't Know the Name, Search Won't Find It Either](/assets/images/deferred-tool-schema-discovery-cost-hero.png)
...
<!-- nlm-visual -->
![Key-concept summary infographic 1](/assets/images/posts/news/deferred-tool-schema-discovery-cost/nlm-infographic-1.png)
...
<!-- nlm-visual -->
![Key-concept summary infographic 2](/assets/images/posts/news/deferred-tool-schema-discovery-cost/nlm-infographic-2.png)
*Infographic generated by NotebookLM from the sources.*
