...
![Abstract rendering of a face held fixed as a wireframe while the surrounding scene and lighting are rebuilt around it](/assets/images/id-v2v-identity-preserving-video-restylization-hero.png)
...
<!-- nlm-visual -->
![Key-concept summary infographic 1](/assets/images/posts/news/id-v2v-identity-preserving-video-restylization/nlm-infographic-1.png)
...
<!-- nlm-visual -->
![Key-concept summary infographic 2](/assets/images/posts/news/id-v2v-identity-preserving-video-restylization/nlm-infographic-2.png)
*Infographic generated by NotebookLM from the sources.*
