...
![Illustration of the core idea of Does a Reasoning-Effort Label Actually Cut Compute? What Qwen3-8B Showed Us](/assets/images/reasoning-effort-token-control-hero.png)
...
<!-- nlm-visual -->
![Key-concept summary infographic 1](/assets/images/posts/news/reasoning-effort-token-control/nlm-infographic-1.png)
...
<!-- nlm-visual -->
![Key-concept summary infographic 2](/assets/images/posts/news/reasoning-effort-token-control/nlm-infographic-2.png)
*Infographic generated by NotebookLM from the sources.*
