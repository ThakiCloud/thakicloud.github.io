...
audiobook: "https://drive.google.com/file/d/1Llwju9DzWlcRQ8BEy8zroh98imUgq3As/view"
audiobook_label: "▶ Listen: 5-minute briefing"
audiobook_note: "NotebookLM audio overview (AI-generated)"
canonical_url: "https://thakicloud.com/tech-blog/en/research/character-identity-edit-vs-adapter/"
---
...
<!-- nlm-visual -->
![Key-concept summary infographic 1](/assets/images/posts/news/character-identity-edit-vs-adapter/en/nlm-infographic-1.webp)
...
<!-- nlm-visual -->
![Key-concept summary infographic 2](/assets/images/posts/news/character-identity-edit-vs-adapter/en/nlm-infographic-2.webp)
*Infographic generated by NotebookLM from the sources.*

## Sources

- [LoRA: Low-Rank Adaptation of Large Language Models](https://arxiv.org/abs/2106.09685) (the original adapter method: freeze pretrained weights, train only low-rank matrices)
- [Learning Transferable Visual Models From Natural Language Supervision](https://arxiv.org/abs/2103.00020) (the CLIP paper; the CLIP-I score used here is cosine similarity between these image embeddings)
- [ArcFace: Additive Angular Margin Loss for Deep Face Recognition](https://arxiv.org/abs/1801.07698) (the standard face-identity metric, which mascots without faces make unusable)
