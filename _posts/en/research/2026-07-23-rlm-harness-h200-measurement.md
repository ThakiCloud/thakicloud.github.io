...
![Illustration of the core idea of Same Model, Different Harness: We Cut Tokens 16x by Measuring RLM on H200](/assets/images/rlm-harness-h200-measurement-hero.png)
...
<!-- nlm-visual -->
![Key-concept summary infographic 1](/assets/images/posts/news/rlm-harness-h200-measurement/nlm-infographic-1.png)
...
![Accuracy by harness]({{ '/assets/images/posts/research/rlm-harness/e1-accuracy.png' | relative_url }})
...
![Token cost by harness]({{ '/assets/images/posts/research/rlm-harness/e1-tokens.png' | relative_url }})
...
<!-- nlm-visual -->
![Key-concept summary infographic 2](/assets/images/posts/news/rlm-harness-h200-measurement/nlm-infographic-2.png)
*Infographic generated by NotebookLM from the sources.*
