...
![Mean and P95 detection lag compared between session-start checks and periodic sweeps](/assets/images/posts/research/skill-state-drift-self-healing/fig-latency-comparison.webp)
...
![Renewal-theory calculation showing how variance in check interval creates the latency gap](/assets/images/posts/research/skill-state-drift-self-healing/fig-inspection-paradox.webp)
...
![Overhead comparison split between number of check events and number of cell scans](/assets/images/posts/research/skill-state-drift-self-healing/fig-overhead.webp)
