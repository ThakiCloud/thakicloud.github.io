...
audiobook: "https://drive.google.com/file/d/1ex1Gabj16-twtjWYaMyJ4sGmehJjK8pn/view"
...
<!-- nlm-visual -->
![Key-concept summary infographic 1](/assets/images/posts/news/boltz2-fep-benchmark-shrinkage/en/nlm-infographic-1.webp)
...
<!-- nlm-visual -->
![Key-concept summary infographic 2](/assets/images/posts/news/boltz2-fep-benchmark-shrinkage/en/nlm-infographic-2.webp)
*Infographic generated by NotebookLM from the sources.*

## Sources

- [The maximal and current accuracy of rigorous protein-ligand binding free energy calculations](https://pmc.ncbi.nlm.nih.gov/articles/PMC10576784/) (Ross et al., Communications Chemistry 2023: the paper behind the FEP+ benchmark scored against here)
- [jwohlwend/boltz](https://github.com/jwohlwend/boltz) (the official Boltz-2 repository, MIT licensed, including how the affinity prediction is used)
- [Boltz-2: Towards Accurate and Efficient Binding Affinity Prediction](https://www.biorxiv.org/content/10.1101/2025.06.14.659707v1) (the Boltz-2 preprint)
- [FEP+ | Schrödinger](https://www.schrodinger.com/platform/products/fep/) (the commercial FEP implementation used as the comparison)
- [PubChem](https://pubchem.ncbi.nlm.nih.gov/) (the database queried for ligands when testing the contamination counterargument)
