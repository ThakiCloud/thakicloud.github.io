...
tags:
  ...
  - wan2
author_profile: true
audiobook: "https://drive.google.com/file/d/17yQH1JvE4jvM5iZuE88Iz3p9uvRHFEIZ/view"
audiobook_label: "▶ Listen: 5-minute briefing"
audiobook_note: "NotebookLM audio overview (AI-generated)"
canonical_url: "https://thakicloud.com/tech-blog/en/research/reference-pose-beats-prompt/"
---
...
![Illustration of the core idea of If Your Mascot Keeps Standing There, Change the References, Not the Prompt](/assets/images/reference-pose-beats-prompt-hero.webp)
...
<!-- nlm-visual -->
![Key-concept summary infographic 1](/assets/images/posts/news/reference-pose-beats-prompt/en/nlm-infographic-1.webp)
...
<!-- nlm-visual -->
![Key-concept summary infographic 2](/assets/images/posts/news/reference-pose-beats-prompt/en/nlm-infographic-2.webp)
*Infographic generated by NotebookLM from the sources.*

## Sources

- [ArcFace: Additive Angular Margin Loss for Deep Face Recognition](https://arxiv.org/abs/1801.07698) (the loss behind the face-recognition identity metric used here)
- [Learning Transferable Visual Models From Natural Language Supervision](https://arxiv.org/abs/2103.00020) (the CLIP paper; the face-free embedding metric is cosine similarity in this image-embedding space)
- [LoRA: Low-Rank Adaptation of Large Language Models](https://arxiv.org/abs/2106.09685) (the original method behind the two adapters trained at matched rank and step count)
