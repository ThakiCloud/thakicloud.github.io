...
![Illustration of the core idea of KV Cache Tiering and Prefill-Decode Disaggregation Together: Does H200 MoE Serving Cost Actually Drop](/assets/images/kv-cache-tiering-pd-disagg-cost-hero.png)
...
![KV cache recovery time compared across tiers](/assets/images/posts/research/kv-cache-tiering-pd-disagg-cost/tier-latency-comparison.png)
...
![Relationship between break-even capacity and the reuse tail exponent](/assets/images/posts/research/kv-cache-tiering-pd-disagg-cost/pareto-breakeven-sensitivity.png)
