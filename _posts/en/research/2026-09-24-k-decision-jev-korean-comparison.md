...
audiobook: "https://drive.google.com/file/d/1CzAKcmkVMfb2M4Zdtha4FSHVBqsxiLaP/view"
...
<!-- nlm-visual -->
![Key-concept summary infographic 1](/assets/images/posts/news/k-decision-jev-korean-comparison/en/nlm-infographic-1.webp)
...
<!-- nlm-visual -->
![Key-concept summary infographic 2](/assets/images/posts/news/k-decision-jev-korean-comparison/en/nlm-infographic-2.webp)
*Infographic generated by NotebookLM from the sources.*

## References

Public materials referenced in this post.
...
- KLUE · [KLUE-benchmark official repository (GitHub)](https://github.com/klue-benchmark/klue)
- AI Hub (KISA) · [Legal and regulation text analysis dataset (AI Hub)](https://www.aihub.or.kr/aihubdata/data/view.do?currMenu=115&topMenu=100&aihubDataSe=data&dataSetSn=71723)
