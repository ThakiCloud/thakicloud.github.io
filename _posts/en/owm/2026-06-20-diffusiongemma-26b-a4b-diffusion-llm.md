...
toc_icon: "cog"
toc_sticky: true
canonical_url: "https://thakicloud.com/tech-blog/en/owm/diffusiongemma-26b-a4b-diffusion-llm/"
reading_time: true
categories:
  - owm
audiobook: "https://drive.google.com/file/d/1e75vmLrsgKFuYHUbPy0UOmDjRyTYdwC8/view"
...
![DiffusionGemma 26B-A4B architecture overview]({{ '/assets/images/diffusiongemma-26b-a4b-diffusion-llm-hero.webp' | relative_url }})

![Illustration of the core idea of DiffusionGemma 26B-A4B: Google's Experiment Generating 15-20 Tokens at Once with Discrete Text Diffusion](/assets/images/diffusiongemma-26b-a4b-diffusion-llm-hero.webp)
...
- [google/diffusiongemma-26B-A4B-it Model Card (Hugging Face)](https://huggingface.co/google/diffusiongemma-26B-A4B-it)
