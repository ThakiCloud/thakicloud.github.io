...
categories:
  - owm
audiobook: "https://drive.google.com/file/d/13vndeDqskEVXB5rX6vUDsjvIwEkIt6_2/view"
...
![Illustration of the core idea of MiniMax-M3: 428B MoE Multimodal, 1M Context and MSA Deliver 9x Faster Prefill Than M2.7](/assets/images/minimax-m3-multimodal-moe-hero.webp)
...
<!-- nlm-visual -->
![Key-concept summary infographic 1](/assets/images/posts/news/minimax-m3-multimodal-moe/en/nlm-infographic-1.webp)
...
<!-- nlm-visual -->
![Key-concept summary infographic 2](/assets/images/posts/news/minimax-m3-multimodal-moe/en/nlm-infographic-2.webp)
*Infographic generated by NotebookLM from the sources.*

## References

Canonical links for the model card and paper referenced above.

- Model card: [MiniMaxAI/MiniMax-M3](https://huggingface.co/MiniMaxAI/MiniMax-M3)
- MSA paper: [arXiv:2606.13392, MiniMax Sparse Attention](https://arxiv.org/abs/2606.13392)
