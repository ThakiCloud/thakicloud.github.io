...
categories:
  - owm
audiobook: "https://drive.google.com/file/d/1PO_F79RpOM_BdS0mMB1PxNkNpEfuhMlS/view"
...
![Illustration of the core idea of NVIDIA Nemotron-3-Ultra-550B: LatentMoE Hybrid, 1M Context, Korean Language Support On-Premises Analysis](/assets/images/nemotron-3-ultra-latentmoe-onprem-hero.webp)
...
<!-- nlm-visual -->
![Key-concept summary infographic 1](/assets/images/posts/news/nemotron-3-ultra-latentmoe-onprem/en/nlm-infographic-1.webp)
...
<!-- nlm-visual -->
![Key-concept summary infographic 2](/assets/images/posts/news/nemotron-3-ultra-latentmoe-onprem/en/nlm-infographic-2.webp)
*Infographic generated by NotebookLM from the sources.*

## References

Canonical links for the model card, license, architecture, and hardware referenced above.

- Model card: [nvidia/NVIDIA-Nemotron-3-Ultra-550B-A55B-BF16](https://huggingface.co/nvidia/NVIDIA-Nemotron-3-Ultra-550B-A55B-BF16)
- License: [OpenMDW-1.1](https://openmdw.ai/license/1-1/)
- Mamba architecture: [state-spaces/mamba](https://github.com/state-spaces/mamba)
- Hardware: [NVIDIA DGX B200](https://www.nvidia.com/en-us/data-center/dgx-b200/)
