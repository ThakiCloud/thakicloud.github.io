...
categories:
  - owm
audiobook: "https://drive.google.com/file/d/18Gr-Bo7pM3wM8bcU7vxAsg5Jgr1UOX6_/view"
...
![Illustration of the core idea of MiniMax-M2.7: 229B Open-Weight Agent Model, 113 Quantization Variants, and License Considerations](/assets/images/minimax-m2-7-openweight-agent-hero.webp)
...
<!-- nlm-visual -->
![Key-concept summary infographic 1](/assets/images/posts/news/minimax-m2-7-openweight-agent/en/nlm-infographic-1.webp)
...
<!-- nlm-visual -->
![Key-concept summary infographic 2](/assets/images/posts/news/minimax-m2-7-openweight-agent/en/nlm-infographic-2.webp)
*Infographic generated by NotebookLM from the sources.*

## References

Canonical links for the model card and official channels referenced above.

- Model card: [MiniMaxAI/MiniMax-M2.7](https://huggingface.co/MiniMaxAI/MiniMax-M2.7)
