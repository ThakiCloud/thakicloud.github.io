...
ebook_pages: 37
audiobook: "https://drive.google.com/file/d/1yJL_1tvDQtPc6tZ-IOybSM2P79tgMQHB/view"
...
<!-- nlm-visual -->
![Key-concept summary infographic 1](/assets/images/posts/news/the-deployment-engineer/en/nlm-infographic-1.webp)
...
<!-- nlm-visual -->
![Key-concept summary infographic 2](/assets/images/posts/news/the-deployment-engineer/en/nlm-infographic-2.webp)
*Infographic generated by NotebookLM from the sources.*

## References

- Separating build, release and run; injecting config from the environment: [The Twelve-Factor App](https://12factor.net/)
- Pinning an artifact to a digest for immutable identity: [OCI Image Spec](https://github.com/opencontainers/image-spec/blob/main/README.md)
- Designing rollback as a traffic swap: [Blue Green Deployment (Martin Fowler)](https://martinfowler.com/bliki/BlueGreenDeployment.html)
- Rolling updates and how rollback works: [Kubernetes Deployments](https://kubernetes.io/docs/concepts/workloads/controllers/deployment/)
