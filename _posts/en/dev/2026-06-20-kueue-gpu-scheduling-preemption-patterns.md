...
![Illustration of the core idea of GPU Workload Preemption with Kueue: ClusterQueue Design and Priority Patterns](/assets/images/kueue-gpu-scheduling-preemption-patterns-hero.webp)
...
<!-- nlm-visual -->
![Key-concept summary infographic 1](/assets/images/posts/news/kueue-gpu-scheduling-preemption-patterns/en/nlm-infographic-1.webp)
...
<!-- nlm-visual -->
![Key-concept summary infographic 2](/assets/images/posts/news/kueue-gpu-scheduling-preemption-patterns/en/nlm-infographic-2.webp)
*Infographic generated by NotebookLM from the sources.*

## References

- The official definition of ClusterQueue resourceGroups/flavors quotas, cross-cohort borrowing, and the reclaimWithinCohort, borrowWithinCohort, and withinClusterQueue preemption fields. Kueue docs, "ClusterQueue". [https://kueue.sigs.k8s.io/docs/concepts/cluster_queue/](https://kueue.sigs.k8s.io/docs/concepts/cluster_queue/)
- Evidence that a LocalQueue is namespace-scoped and points at a single ClusterQueue (Pitfall 3). Kueue docs, "LocalQueue". [https://kueue.sigs.k8s.io/docs/concepts/local_queue/](https://kueue.sigs.k8s.io/docs/concepts/local_queue/)
- The source for MultiKueue being a beta feature that is enabled by default. Kueue docs, "MultiKueue". [https://kueue.sigs.k8s.io/docs/concepts/multikueue/](https://kueue.sigs.k8s.io/docs/concepts/multikueue/)
- Cooperative preemption is an upstream proposal to use checkpoint information when choosing preemption targets, not a shipped release. kubernetes-sigs/kueue issue #477, "Use information about last checkpoint on preemption". [https://github.com/kubernetes-sigs/kueue/issues/477](https://github.com/kubernetes-sigs/kueue/issues/477)
- The `preemptionPolicy: PreemptLowerPriority` and `Never` semantics used in the PriorityClass examples are standard Kubernetes API behavior. Kubernetes docs, "Pod Priority and Preemption". [https://kubernetes.io/docs/concepts/scheduling-eviction/pod-priority-preemption/](https://kubernetes.io/docs/concepts/scheduling-eviction/pod-priority-preemption/)
