...
ebook_pages: 31
audiobook: "https://drive.google.com/file/d/17jaRt9UxSJCw-IzEVESZRr_lDX1bS585/view"
...
<!-- nlm-visual -->
![Key-concept summary infographic 1](/assets/images/posts/news/the-error-budget/en/nlm-infographic-1.webp)
...
<!-- nlm-visual -->
![Key-concept summary infographic 2](/assets/images/posts/news/the-error-budget/en/nlm-infographic-2.webp)
*Infographic generated by NotebookLM from the sources.*

## References

The SLO and SLI definitions, the burn-rate alerting, and the shape of the error budget policy in the body cross-check against these materials. The freeze threshold in the body is an estimate, the author's operational starting point, not a verified constant.

- [Google SRE Book: Monitoring Distributed Systems (SLO and SLI definitions)](https://sre.google/sre-book/monitoring-distributed-systems/)
