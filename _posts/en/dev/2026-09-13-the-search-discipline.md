...
ebook_pages: 31
audiobook: "https://drive.google.com/file/d/1G01oiBySyzPjZr7NslMKnlS3SKAEJr44/view"
...
<!-- nlm-visual -->
![Key-concept summary infographic 1](/assets/images/posts/news/the-search-discipline/en/nlm-infographic-1.webp)
...
<!-- nlm-visual -->
![Key-concept summary infographic 2](/assets/images/posts/news/the-search-discipline/en/nlm-infographic-2.webp)
*Infographic generated by NotebookLM from the sources.*

## References

The B-tree prefix behavior, the 3-character slicing in pg_trgm, full-text index limits, EXPLAIN and index-usage examination, and Korean morphological analysis in the body cross-check against these materials.

- [pg_trgm: similarity of text using trigram matching (PostgreSQL docs)](https://www.postgresql.org/docs/current/pgtrgm.html)
- [Index Types: B-tree, GiST, GIN (PostgreSQL docs)](https://www.postgresql.org/docs/current/indexes-types.html)
- [Examining Index Usage (PostgreSQL docs)](https://www.postgresql.org/docs/current/indexes-examine.html)
- [Using EXPLAIN (PostgreSQL docs)](https://www.postgresql.org/docs/current/using-explain.html)
- [Full Text Search (PostgreSQL docs)](https://www.postgresql.org/docs/current/textsearch.html)
- [KoNLPy: Korean NLP in Python, with KKMA and MecabKo tokenizers](https://konlpy.org/)
