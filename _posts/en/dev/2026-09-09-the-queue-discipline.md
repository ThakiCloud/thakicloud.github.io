...
ebook_pages: 33
audiobook: "https://drive.google.com/file/d/1Bd1_YYHOi_fuYxJWtbSC_mEjNclc4XeL/view"
...
<!-- nlm-visual -->
![Key-concept summary infographic 1](/assets/images/posts/news/the-queue-discipline/en/nlm-infographic-1.webp)
...
<!-- nlm-visual -->
![Key-concept summary infographic 2](/assets/images/posts/news/the-queue-discipline/en/nlm-infographic-2.webp)
*Infographic generated by NotebookLM from the sources.*

## References

At-least-once delivery and idempotency, the visibility-timeout range, worker respawn, and the retry cap with dead letters in the body cross-check against these materials. The values marked [estimate] are the author's operational starting points.

- [Amazon SQS FAQ: visibility timeout, dead letter queues, message delivery (AWS)](https://aws.amazon.com/sqs/faqs/)
- [Idempotent requests (Stripe API docs)](https://docs.stripe.com/api/idempotent_requests)
- [Idempotence (Wikipedia)](https://en.wikipedia.org/wiki/Idempotence)
- [systemd.service(5): Restart= option (man7.org)](https://man7.org/linux/man-pages/man5/systemd.service.5.html)
- [BullMQ: message queue with retries and dead letters (GitHub)](https://github.com/taskforcesh/bullmq)
