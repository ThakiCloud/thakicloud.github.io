...
ebook_pages: 31
audiobook: "https://drive.google.com/file/d/1yS6aeCG7wYAL5IuKscLIyPHWkOIM_q3n/view"
...
<!-- nlm-visual -->
![Key-concept summary infographic 1](/assets/images/posts/news/the-backup-discipline/en/nlm-infographic-1.webp)
...
<!-- nlm-visual -->
![Key-concept summary infographic 2](/assets/images/posts/news/the-backup-discipline/en/nlm-infographic-2.webp)
*Infographic generated by NotebookLM from the sources.*

## References

- [IT disaster recovery - Wikipedia](https://en.wikipedia.org/wiki/IT_disaster_recovery): defines RTO and RPO, and describes how recovery controls are exercised regularly through DR tests and how regular testing verifies a plan's effectiveness.
- [Backup - Wikipedia](https://en.wikipedia.org/wiki/Backup): covers backup methods, the difference between backup and mirroring or replication, and restore and data integrity.
