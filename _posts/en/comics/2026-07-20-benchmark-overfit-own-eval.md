...
author_profile: true
toc: false
image: /assets/images/posts/comics/benchmark-overfit-own-eval/strip.png
...
![Aced the Exam, Blanked on the Job]({{ '/assets/images/posts/comics/benchmark-overfit-own-eval/strip.png' | relative_url }})
