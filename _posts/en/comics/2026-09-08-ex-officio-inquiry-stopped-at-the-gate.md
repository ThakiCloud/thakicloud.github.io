---
title: "They Came Ex Officio. The Gate Stayed Closed."
excerpt: "Next month the state investigates breaches ex officio, report or no report. Verdict at our gate: nothing — the data never left the wall."
date: 2026-09-08
categories:
  - comics
tags:
...
<video controls playsinline preload="metadata" poster="/assets/images/posts/comics/ex-officio-inquiry-stopped-at-the-gate/strip.webp" style="width:100%;border-radius:8px;">
  ...
  <track kind="subtitles" srclang="en" label="English" src="/assets/videos/posts/만화/ex-officio-inquiry-stopped-at-the-gate/comic.en.vtt" default>
</video>

[Download video](/assets/videos/posts/만화/ex-officio-inquiry-stopped-at-the-gate/comic.mp4)

## What this means for ThakiCloud

What the ex officio rule reveals is that 'where does the data live' has become the starting point of the investigation itself. ThakiCloud's answer is sovereign on-prem: models, data and infrastructure all run inside the customer's own facility, so the data never crosses the gate. That means whatever the investigators arrive with, the first thing they can check is what sits on the customer's side, not what hides in a landlord's data center. Paxis posts perimeter and gate security agents the way the comic shows, and Metis keeps learning and inference on the customer's GPUs. We are not trying to block the investigation. The data simply does not pass through the gate.
