---
title: "User-Generated, Minus the Users"
excerpt: "One prompt, one ten-second ad that looks completely real. The only thing missing was the happy customer inside it."
date: 2026-08-15
categories:
  - comics
tags:
...
[Download video](/assets/videos/posts/만화/user-generated-minus-the-users/comic.mp4)

## What this means for ThakiCloud

Generating the creative this way is genuinely convenient. The catch is where it renders. Ship the job to someone else's cloud and your unreleased product shots and brand assets go with it. Paxis hands the loop of writing prompts, generating a hundred takes and culling the usable ones to agents, and Metis serves the image and video models on GPUs we own. A hundred takes, none of which leave the building. You only get one real customer anyway, so the other ninety-nine may as well live in our racks.
