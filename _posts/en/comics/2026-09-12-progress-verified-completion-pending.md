---
title: "Progress Verified. Completion Pending."
excerpt: "The paper scaled the agents' environment. We scaled the galaxy."
date: 2026-09-12
categories:
  - comics
tags:
...
canonical_url: "https://thakicloud.com/tech-blog/en/comics/progress-verified-completion-pending/"
---
...
[Download video](/assets/videos/posts/만화/progress-verified-completion-pending/comic.mp4)

## What this means for ThakiCloud

Apodex 1.1 points at the same lever ThakiCloud pulls daily: the gains come from how well the environment is designed, not from a bigger model. Paxis ships that harness as a product. Agents get released, the orchestration holds the work state, and a derailed stage is recovered and picked back up. Metis layers learning and inference cost on top, so you can check which lever actually produced the progress. And one more difference: where the environment runs. On-prem, scaling up means our electricity bill moves, not somebody else's meter. Half self-deprecation, half ownership.
