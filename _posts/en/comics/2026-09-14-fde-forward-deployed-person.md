---
title: "They Forward-Deployed the Headcount, Not the Stack"
excerpt: "Big tech parks its engineers inside client offices now. The only thing deployed forward is the person."
date: 2026-09-14
categories:
  - comics
tags:
...
[Download video](/assets/videos/posts/만화/fde-forward-deployed-person/comic.mp4)

## What this means for ThakiCloud

The 'Korean-style FDE' in the comic is closer to how we actually staff a site. Paxis places an agent on the ground instead of a person, so the line item switches from per diem to electricity. Add Metis to the same building and the equation changes: model, data, inference, and the invoice all run inside the fence. That is on-prem, and it is what ThakiCloud means by sovereignty. In an era of on-site engineers, we forward-deployed the stack instead.
