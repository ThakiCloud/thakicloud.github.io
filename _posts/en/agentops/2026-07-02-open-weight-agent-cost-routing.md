...
categories:
  - agentops
audiobook: "https://drive.google.com/file/d/1ZZqJS2gzUzQyn3mWVvzSt-7imWEm06m2/view"
...
![Illustration of the core idea of Route Every Task to Its Winning Model: How We Cut Agent Automation Costs 44x with Open-Weight Models](/assets/images/open-weight-agent-cost-routing-hero.webp)
...
<!-- nlm-visual -->
![Key-concept summary infographic 1](/assets/images/posts/news/open-weight-agent-cost-routing/en/nlm-infographic-1.webp)
...
<!-- nlm-visual -->
![Key-concept summary infographic 2](/assets/images/posts/news/open-weight-agent-cost-routing/en/nlm-infographic-2.webp)
*Infographic generated by NotebookLM from the sources.*
