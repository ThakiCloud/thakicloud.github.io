...
![An abstract image depicting an agent gaining sight as video frames and audio waveforms flow into a single lens]({{ '/assets/images/claude-video-agent-watch-hero.webp' | relative_url }})

<!-- nlm-visual -->
![Key-concept summary infographic 1](/assets/images/posts/news/claude-video-agent-watch/en/nlm-infographic-1.webp)
...
<!-- nlm-visual -->
![Key-concept summary infographic 2](/assets/images/posts/news/claude-video-agent-watch/en/nlm-infographic-2.webp)
*Infographic generated by NotebookLM from the sources.*
