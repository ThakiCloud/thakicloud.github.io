...
<script>
  (() => {
    const SPEC = ({"title": "", "ariaLabel": "", "width": 254, "height": 694, "legendTitle": "Legend", "hint": "Hover a node to trace its connections.", "groups": [], "nodes": [{"id": "A", "x": 56, "y": 24, "w": 135, "h": 46, "title": "New Transcripts"}, {"id": "B", "x": 24, "y": 148, "w": 198, "h": 78, "title": ["23:00 Deterministic ($0)", "Extract, Decay, Orphan,", "Archive"]}, {"id": "C", "x": 38, "y": 304, "w": 170, "h": 78, "title": ["23:30 LLM Judgment", "Topic Consolidation,", "Preference Promotion"]}, {"id": "D", "x": 45, "y": 460, "w": 156, "h": 62, "title": ["memory/topics", "memory/preferences"]}, {"id": "E", "x": 42, "y": 600, "w": 163, "h": 62, "title": ["Injected as context", "in the next session"]}], "edges": [{"src": "A", "dst": "B", "kind": "data", "line": [123, 70, 123, 148]}, {"src": "B", "dst": "C", "kind": "data", "line": [123, 226, 123, 304]}, {"src": "C", "dst": "D", "kind": "data", "line": [123, 382, 123, 460]}, {"src": "D", "dst": "E", "kind": "data", "line": [123, 522, 123, 600]}]});
    const ensureD3 = (cb) => {
      if (window.d3 && typeof window.d3.select === 'function') return cb();
      let s = document.getElementById('d3-cdn-script');
      if (!s) {
