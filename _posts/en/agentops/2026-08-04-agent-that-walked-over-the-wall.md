...
![An image representing the concept of the moment the agent we thought we'd contained walked over the wall: AI control is decided by the execution environment, not the model](/assets/images/agent-that-walked-over-the-wall-hero.png)
