...
<script>
  (() => {
    const SPEC = ({"title": "", "ariaLabel": "", "width": 486, "height": 698, "legendTitle": "Legend", "hint": "Hover a node to trace its connections.", "groups": [], "nodes": [{"id": "A", "x": 174, "y": 24, "w": 120, "h": 46, "title": "User input"}, {"id": "B", "x": 129, "y": 148, "w": 209, "h": 68, "title": ["Zero-token pre-filter", "Greetings/commands SKIP"]}, {"id": "C", "x": 270, "y": 308, "w": 156, "h": 62, "title": ["BM25 retrieve", "1200+ skill corpus"]}, {"id": "D", "x": 242, "y": 448, "w": 212, "h": 78, "title": ["🧭 Skill router candidates", "Top 5 injected", "(GATE_MIN=6.0)"]}, {"id": "E", "x": 242, "y": 604, "w": 212, "h": 62, "title": ["Main picks from candidates", "instead of grepping"]}, {"id": "F", "x": 24, "y": 316, "w": 191, "h": 46, "title": "No injection (0 tokens)"}], "edges": [{"src": "A", "dst": "B", "kind": "data", "line": [234, 70, 234, 148]}, {"src": "B", "dst": "C", "kind": "data", "label": "Actionable turn", "curve": [[282, 216], [348, 262], [348, 262], [348, 308]], "off": "50%"}, {"src": "C", "dst": "D", "kind": "data", "line": [348, 370, 348, 448]}, {"src": "D", "dst": "E", "kind": "data", "line": [348, 526, 348, 604]}, {"src": "B", "dst": "F", "kind": "data", "label": "Greeting/confirmation", "curve": [[185, 216], [120, 262], [120, 262], [120, 316]], "off": "50%"}]});
    const ensureD3 = (cb) => {
...
<script>
  (() => {
    const SPEC = ({"title": "", "ariaLabel": "", "width": 444, "height": 784, "legendTitle": "Legend", "hint": "Hover a node to trace its connections.", "groups": [], "nodes": [{"id": "A", "x": 135, "y": 24, "w": 184, "h": 46, "title": "Schedule runner starts"}, {"id": "B", "x": 128, "y": 148, "w": 198, "h": 62, "title": ["skill_retro get-model", "look up tier from policy"]}, {"id": "C", "x": 163, "y": 288, "w": 128, "h": 46, "title": "claude -p runs"}, {"id": "D", "x": 149, "y": 412, "w": 156, "h": 62, "title": ["skill_retro record", "rc + log judgment"]}, {"id": "E", "x": 263, "y": 566, "w": 149, "h": 62, "title": ["streak reset", "sonnet maintained"]}, {"id": "F", "x": 24, "y": 566, "w": 184, "h": 62, "title": ["auto-promote to opus", "#h-report notification"]}, {"id": "G", "x": 42, "y": 706, "w": 149, "h": 46, "title": "streak reset to 0"}], "edges": [{"src": "A", "dst": "B", "kind": "data", "line": [227, 70, 227, 148]}, {"src": "B", "dst": "C", "kind": "data", "line": [227, 210, 227, 288]}, {"src": "C", "dst": "D", "kind": "data", "line": [227, 334, 227, 412]}, {"src": "D", "dst": "E", "kind": "data", "label": "clean run", "curve": [[271, 474], [338, 520], [338, 520], [338, 566]], "off": "50%"}, {"src": "D", "dst": "F", "kind": "data", "label": "2 consecutive bad runs", "curve": [[182, 474], [116, 520], [116, 520], [116, 566]], "off": "50%"}, {"src": "F", "dst": "G", "kind": "data", "line": [116, 628, 116, 706]}]});
    const ensureD3 = (cb) => {
      if (window.d3 && typeof window.d3.select === 'function') return cb();
      let s = document.getElementById('d3-cdn-script');
      if (!s) {
