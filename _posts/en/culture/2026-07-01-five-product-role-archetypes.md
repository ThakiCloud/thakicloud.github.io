...
<script>
  (() => {
    const SPEC = ({"title": "", "ariaLabel": "", "width": 317, "height": 740, "legendTitle": "Legend", "legend": {"data": "Flow", "event": "Dotted / alternate path"}, "hint": "Hover a node to trace its connections.", "groups": [], "nodes": [{"id": "P", "x": 59, "y": 24, "w": 170, "h": 62, "title": ["Prototyper", "churns out new ideas"]}, {"id": "B", "x": 73, "y": 164, "w": 142, "h": 78, "title": ["Builder", "converts to", "production-grade"]}, {"id": "S", "x": 136, "y": 320, "w": 135, "h": 78, "title": ["Sweeper", "simplify, tidy,", "performance"]}, {"id": "G", "x": 122, "y": 490, "w": 163, "h": 62, "title": ["Grower", "iterates toward PMF"]}, {"id": "M", "x": 38, "y": 630, "w": 212, "h": 78, "title": ["Maintainer", "keeps security, stability,", "scale"]}], "edges": [{"src": "P", "dst": "B", "kind": "data", "line": [144, 86, 144, 164]}, {"src": "B", "dst": "S", "kind": "data", "curve": [[174, 242], [204, 281], [204, 281], [204, 320]]}, {"src": "S", "dst": "G", "kind": "data", "line": [204, 398, 204, 490]}, {"src": "G", "dst": "M", "kind": "data", "curve": [[204, 552], [204, 591], [204, 591], [174, 630]]}, {"src": "M", "dst": "B", "kind": "event", "label": "maintain / reinvent", "curve": [[115, 630], [85, 521], [85, 359], [115, 242]], "off": "50%"}]});
    const ensureD3 = (cb) => {
...
<script>
  (() => {
    const SPEC = ({"title": "", "ariaLabel": "", "width": 619, "height": 426, "legendTitle": "Legend", "hint": "Hover a node to trace its connections.", "groups": [], "nodes": [{"id": "PRE", "x": 66, "y": 24, "w": 120, "h": 62, "title": ["Pre-PMF", "new product"]}, {"id": "GROW", "x": 66, "y": 178, "w": 120, "h": 62, "title": ["Growth stage", "PMF found"]}, {"id": "MATURE", "x": 66, "y": 332, "w": 120, "h": 62, "title": ["Maturity", "strong PMF"]}, {"id": "Grower", "x": 241, "y": 32, "w": 156, "h": 46, "title": "+ light Maintainer"}, {"id": "Maintainer", "x": 452, "y": 32, "w": 135, "h": 46, "title": "+ light Builder"}], "edges": [{"src": "PRE", "dst": "GROW", "kind": "data", "label": "\"Prototyper + Builder + Sweeper\"", "line": [126, 86, 126, 178], "lx": 126, "ly": 128}, {"src": "GROW", "dst": "MATURE", "kind": "data", "label": "\"Builder + Sweeper + Grower\"", "line": [126, 240, 126, 332], "lx": 126, "ly": 282}, {"src": "MATURE", "dst": "MATURE", "kind": "data", "label": "\"Sweeper + Grower + Maintainer\"", "curve": [[186, 351], [300, 332], [300, 394], [186, 375]], "off": "50%"}]});
    const ensureD3 = (cb) => {
      if (window.d3 && typeof window.d3.select === 'function') return cb();
      let s = document.getElementById('d3-cdn-script');
      if (!s) {
