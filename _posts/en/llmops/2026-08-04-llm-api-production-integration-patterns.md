...
ebook_pages: 40
audiobook: "https://drive.google.com/file/d/1PikZY5JkiI0wiBtC_PIxi2NT7Z_Cy5QT/view"
...
![Illustration of the core idea of Four Control Points That Turn an LLM API Into a Reliable Component](/assets/images/llm-api-production-integration-patterns-hero.webp)
...
<!-- nlm-visual -->
![Key-concept summary infographic 1](/assets/images/posts/news/llm-api-production-integration-patterns/en/nlm-infographic-1.webp)
...
- Schema-based structured outputs: [Instructor](https://python.useinstructor.com/)
...
- Streaming transport, SSE: [Using server-sent events (MDN)](https://developer.mozilla.org/en-US/docs/Web/API/Server-sent_events/Using_server-sent_events)
- LLM span tracing conventions: [OpenTelemetry GenAI semantic conventions](https://github.com/open-telemetry/semantic-conventions/blob/main/docs/gen-ai/gen-ai-spans.md)

<!-- nlm-visual -->
![Key-concept summary infographic 2](/assets/images/posts/news/llm-api-production-integration-patterns/en/nlm-infographic-2.webp)
*Infographic generated by NotebookLM from the sources.*
