...
![Bar chart showing the distribution of fusion-target nodes in the torch.fx graph]({{ '/assets/images/vllm-transformers-native-speed-results.webp' | relative_url }})
