...
<script>
  (() => {
    const SPEC = ({"title": "", "ariaLabel": "", "width": 374, "height": 632, "legendTitle": "Legend", "hint": "Hover a node to trace its connections.", "groups": [], "nodes": [{"id": "A", "x": 96, "y": 24, "w": 120, "h": 46, "title": "Pending"}, {"id": "B", "x": 96, "y": 148, "w": 120, "h": 46, "title": "Queued"}, {"id": "C", "x": 140, "y": 286, "w": 202, "h": 52, "title": "Quota + resources met?"}, {"id": "D", "x": 181, "y": 430, "w": 120, "h": 46, "title": "Running"}, {"id": "E", "x": 199, "y": 554, "w": 120, "h": 46, "title": "Completed"}, {"id": "F", "x": 24, "y": 554, "w": 120, "h": 46, "title": "Failed"}], "edges": [{"src": "A", "dst": "B", "kind": "data", "line": [156, 70, 156, 148]}, {"src": "B", "dst": "C", "kind": "data", "curve": [[189, 194], [254, 240], [254, 240], [246, 286]]}, {"src": "C", "dst": "B", "kind": "data", "label": "No", "curve": [[210, 286], [156, 240], [156, 240], [156, 194]], "off": "50%"}, {"src": "C", "dst": "D", "kind": "data", "label": "Yes", "line": [241, 338, 241, 430], "lx": 241, "ly": 380}, {"src": "D", "dst": "E", "kind": "data", "line": [248, 476, 259, 554]}, {"src": "D", "dst": "F", "kind": "data", "line": [208, 476, 110, 554]}, {"src": "F", "dst": "B", "kind": "data", "curve": [[80, 554], [74, 453], [74, 312], [129, 194]]}]});
    const ensureD3 = (cb) => {
...
<script>
  (() => {
    const SPEC = ({"title": "", "ariaLabel": "", "width": 507, "height": 896, "legendTitle": "Legend", "legend": {"data": "Flow", "event": "Dotted / alternate path"}, "hint": "Hover a node to trace its connections.", "groups": [], "nodes": [{"id": "R", "x": 175, "y": 24, "w": 149, "h": 46, "title": "Inference request"}, {"id": "G", "x": 147, "y": 148, "w": 205, "h": 46, "title": "OpenAI-compatible gateway"}, {"id": "K", "x": 170, "y": 272, "w": 160, "h": 52, "title": "Active replicas?"}, {"id": "Z", "x": 224, "y": 416, "w": 198, "h": 46, "title": "KEDA: scale up from zero"}, {"id": "V", "x": 190, "y": 540, "w": 120, "h": 46, "title": "vLLM engine"}, {"id": "B", "x": 277, "y": 678, "w": 198, "h": 62, "title": ["Continuous batching + KV", "cache"]}, {"id": "O", "x": 316, "y": 818, "w": 120, "h": 46, "title": "Response"}, {"id": "S", "x": 24, "y": 686, "w": 198, "h": 46, "title": "KEDA: scale down to zero"}], "edges": [{"src": "R", "dst": "G", "kind": "data", "line": [250, 70, 250, 148]}, {"src": "G", "dst": "K", "kind": "data", "line": [250, 194, 250, 272]}, {"src": "K", "dst": "Z", "kind": "data", "label": "No", "curve": [[276, 324], [323, 370], [323, 370], [323, 416]], "off": "50%"}, {"src": "K", "dst": "V", "kind": "data", "label": "Yes", "curve": [[223, 324], [176, 370], [176, 501], [222, 540]], "off": "50%"}, {"src": "Z", "dst": "V", "kind": "data", "curve": [[323, 462], [323, 501], [323, 501], [277, 540]]}, {"src": "V", "dst": "B", "kind": "data", "curve": [[292, 586], [376, 632], [376, 632], [376, 678]]}, {"src": "B", "dst": "O", "kind": "data", "line": [376, 740, 376, 818]}, {"src": "V", "dst": "S", "kind": "event", "label": "Idle persists", "curve": [[207, 586], [123, 632], [123, 632], [123, 686]], "off": "50%"}]});
    const ensureD3 = (cb) => {
      if (window.d3 && typeof window.d3.select === 'function') return cb();
      let s = document.getElementById('d3-cdn-script');
      if (!s) {
...
<script>
  (() => {
    const SPEC = ({"title": "", "ariaLabel": "", "width": 640, "height": 566, "legendTitle": "Legend", "legend": {"data": "Flow", "event": "Dotted / alternate path"}, "hint": "Hover a node to trace its connections.", "groups": [{"x": 24, "y": 24, "w": 363, "h": 510, "label": "Customer Workspace", "lx": 36, "ly": 42}], "nodes": [{"id": "Q", "x": 122, "y": 63, "w": 205, "h": 46, "title": "Per-team quotas & budgets"}, {"id": "SC", "x": 155, "y": 187, "w": 184, "h": 46, "title": "Fair-share GPU sharing"}, {"id": "SZ", "x": 158, "y": 325, "w": 177, "h": 46, "title": "Scale-to-zero serving"}, {"id": "SB", "x": 106, "y": 449, "w": 156, "h": 46, "title": "Showback dashboard"}, {"id": "OP", "x": 424, "y": 187, "w": 184, "h": 46, "title": "On-prem air-gap option"}], "edges": [{"src": "Q", "dst": "SC", "kind": "data", "curve": [[233, 109], [247, 148], [247, 148], [247, 187]]}, {"src": "SC", "dst": "SZ", "kind": "data", "line": [247, 233, 247, 325]}, {"src": "SZ", "dst": "SB", "kind": "data", "curve": [[247, 371], [247, 410], [247, 410], [208, 449]]}, {"src": "SB", "dst": "Q", "kind": "event", "label": "measure → adjust", "curve": [[159, 449], [117, 348], [117, 210], [185, 109]], "off": "50%"}, {"src": "Q", "dst": "OP", "kind": "data", "curve": [[259, 109], [317, 148], [317, 148], [442, 187]]}]});
    const ensureD3 = (cb) => {
      if (window.d3 && typeof window.d3.select === 'function') return cb();
      let s = document.getElementById('d3-cdn-script');
      if (!s) {
