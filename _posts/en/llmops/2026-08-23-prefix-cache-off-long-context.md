...
audiobook: "https://drive.google.com/file/d/1KTDsu4gKzN1B89qRoRwSgvKq3q--UtE0/view"
...
<!-- nlm-visual -->
![Key-concept summary infographic 1](/assets/images/posts/news/prefix-cache-off-long-context/en/nlm-infographic-1.webp)
...
<!-- nlm-visual -->
![Key-concept summary infographic 2](/assets/images/posts/news/prefix-cache-off-long-context/en/nlm-infographic-2.webp)
*Infographic generated by NotebookLM from the sources.*

## References

Canonical links for the engine, architecture, and hardware.

- vLLM: [vllm-project/vllm](https://github.com/vllm-project/vllm)
- vLLM Automatic Prefix Caching: [docs.vllm.ai](https://docs.vllm.ai/en/latest/features/automatic_prefix_caching/)
- Qwen3-Next (hybrid GDN): [Qwen/Qwen3.8-Flash-Next](https://huggingface.co/Qwen/Qwen3.8-Flash-Next)
