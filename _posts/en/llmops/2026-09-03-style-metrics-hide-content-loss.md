...
audiobook: "https://drive.google.com/file/d/1Hl9UfvY5aOrs2Z2Rud7vTPpuSHuCxnA8/view"
...
![Illustration of the core idea of A Better Style Score Does Not Mean a Better Text](/assets/images/style-metrics-hide-content-loss-hero.webp)
...
<!-- nlm-visual -->
![Key-concept summary infographic 1](/assets/images/posts/news/style-metrics-hide-content-loss/en/nlm-infographic-1.webp)
...
```mermaid
flowchart TB
    SRC["Bureaucratic original<br/>101 legal interpretation replies"] --> RW["Plain-language rewrite"]
    RW --> S["Style metric, five axes<br/>long sentences · stock phrases · passives · nominalizations · citation density"]
    RW --> P["Preservation gate, three checks<br/>length at least 60% of the original<br/>statute names survive<br/>numbers survive"]
    S --> Q1["Easier?"]
    P --> Q2["Still there?"]
    Q1 --> G["Both must pass to keep"]
    Q2 --> G
```

*Two measurements that split from the same rewrite. The style metric checks whether the room is clean; the preservation gate checks whether the things are still in it.*
...
<!-- nlm-visual -->
![Key-concept summary infographic 2](/assets/images/posts/news/style-metrics-hide-content-loss/en/nlm-infographic-2.webp)
*Infographic generated by NotebookLM from the sources.*
...
source material from the [Korea Ministry of Government Legislation open API](https://open.law.go.kr/LSO/openApi/guideList.do)
under an open government license ([dataset page](https://www.data.go.kr/data/15000115/openapi.do)).
