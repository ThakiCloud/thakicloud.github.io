...
lang: en
audiobook: "https://drive.google.com/file/d/1CHGv9lnOZtcfds6Csy-C8uLz63ObrtyO/view"
...
![Illustration of the core idea of Generative Music Won't Change Its Voice for a Caption: A Record of Ripping Out the Vocal and Swapping It In](/assets/images/generative-music-voice-swap-chain-hero.webp)
...
<!-- nlm-visual -->
![Key-concept summary infographic 1](/assets/images/posts/news/generative-music-voice-swap-chain/en/nlm-infographic-1.webp)
...
<!-- nlm-visual -->
![Key-concept summary infographic 2](/assets/images/posts/news/generative-music-voice-swap-chain/en/nlm-infographic-2.webp)
*Infographic generated by NotebookLM from the sources.*

## References

Canonical links for the open-source tools in the chain.
