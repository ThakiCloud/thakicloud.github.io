...
categories:
  - llmops
audiobook: "https://drive.google.com/file/d/17Yxhc2hZw1mFsKC9N87WxrHrNUK5XBYq/view"
...
![Illustration of the core idea of We Benchmarked Four Multilingual TTS Models on the Same GPU: A 12x Gap and Three Scorers That Lied](/assets/images/multilingual-tts-serving-measured-hero.webp)
...
<!-- nlm-visual -->
![Key-concept summary infographic 1](/assets/images/posts/news/multilingual-tts-serving-measured/en/nlm-infographic-1.webp)
...
<!-- nlm-visual -->
![Key-concept summary infographic 2](/assets/images/posts/news/multilingual-tts-serving-measured/en/nlm-infographic-2.webp)
*Infographic generated by NotebookLM from the sources.*

## References

- Qwen3-TTS model: [QwenLM/Qwen3-TTS](https://github.com/QwenLM/Qwen3-TTS)
- VoxCPM2 model: [openbmb/VoxCPM2 (Hugging Face)](https://huggingface.co/openbmb/VoxCPM2)
- Supertonic-3 model: [Supertone/supertonic-3 (Hugging Face)](https://huggingface.co/Supertone/supertonic-3)
- Kokoro-82M model: [hexgrad/Kokoro-82M (Hugging Face)](https://huggingface.co/hexgrad/Kokoro-82M)
- ASR for the clarity axis: [openai/whisper-large-v3 (Hugging Face)](https://huggingface.co/openai/whisper-large-v3)
- Naturalness metric UTMOS (v1, 2022) implementation: [UTMOS PyTorch implementation](https://github.com/Blinorot/UTMOS-PyTorch)
