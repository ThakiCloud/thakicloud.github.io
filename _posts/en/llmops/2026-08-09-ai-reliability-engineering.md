...
ebook_pages: 24
audiobook: "https://drive.google.com/file/d/1mSonP7o-u6Kz8pgRkyfOFL0m2BKoE6v7/view"
...
<!-- nlm-visual -->
![Key-concept summary infographic 1](/assets/images/posts/news/ai-reliability-engineering/en/nlm-infographic-1.webp)
...
- Graceful degradation: [Fault tolerance, Graceful degradation (Wikipedia)](https://en.wikipedia.org/wiki/Fault_tolerance#Graceful_degradation)
- Circuit breaker pattern: [Circuit Breaker (Martin Fowler)](https://martinfowler.com/bliki/CircuitBreaker.html)
- Feature flags: [Feature Flag (Martin Fowler)](https://martinfowler.com/bliki/FeatureFlag.html)
- Incident severity and response stages: [Managing Incidents (Google SRE Book)](https://sre.google/sre-book/managing-incidents/)
- Postmortem culture: [Postmortem Culture (Google SRE Book)](https://sre.google/sre-book/postmortem-culture/)

<!-- nlm-visual -->
![Key-concept summary infographic 2](/assets/images/posts/news/ai-reliability-engineering/en/nlm-infographic-2.webp)
*Infographic generated by NotebookLM from the sources.*
