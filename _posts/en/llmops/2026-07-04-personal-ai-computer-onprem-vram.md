...
![Required VRAM by model size and quantization, with the capacity lines of the three build configurations](/assets/images/personal-ai-computer-onprem-vram-results.png)
