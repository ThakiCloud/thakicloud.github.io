...
<script>
  (() => {
    const SPEC = ({"title": "", "ariaLabel": "", "width": 486, "height": 758, "legendTitle": "Legend", "hint": "Hover a node to trace its connections.", "groups": [], "nodes": [{"id": "A", "x": 188, "y": 24, "w": 120, "h": 46, "title": "Input Prompt"}, {"id": "B", "x": 168, "y": 148, "w": 160, "h": 52, "title": "Algorithm Choice"}, {"id": "C", "x": 284, "y": 292, "w": 170, "h": 46, "title": "Token Group Sampling"}, {"id": "D", "x": 35, "y": 292, "w": 184, "h": 46, "title": "Full Sequence Sampling"}, {"id": "E", "x": 284, "y": 416, "w": 170, "h": 62, "title": ["Group-level Relative", "Ranking"]}, {"id": "F", "x": 24, "y": 416, "w": 205, "h": 62, "title": ["Sequence-level Importance", "Ratio"]}, {"id": "G", "x": 284, "y": 556, "w": 170, "h": 46, "title": "Token-level Clipping"}, {"id": "H", "x": 31, "y": 556, "w": 191, "h": 46, "title": "Sequence-level Clipping"}, {"id": "I", "x": 187, "y": 680, "w": 121, "h": 46, "title": "Policy Update"}], "edges": [{"src": "A", "dst": "B", "kind": "data", "line": [248, 70, 248, 148]}, {"src": "B", "dst": "C", "kind": "data", "label": "GRPO", "curve": [[292, 200], [369, 246], [369, 246], [369, 292]], "off": "50%"}, {"src": "B", "dst": "D", "kind": "data", "label": "GSPO", "curve": [[204, 200], [127, 246], [127, 246], [127, 292]], "off": "50%"}, {"src": "C", "dst": "E", "kind": "data", "line": [369, 338, 369, 416]}, {"src": "D", "dst": "F", "kind": "data", "line": [127, 338, 127, 416]}, {"src": "E", "dst": "G", "kind": "data", "line": [369, 478, 369, 556]}, {"src": "F", "dst": "H", "kind": "data", "line": [127, 478, 127, 556]}, {"src": "G", "dst": "I", "kind": "data", "curve": [[369, 602], [369, 641], [369, 641], [293, 680]]}, {"src": "H", "dst": "I", "kind": "data", "curve": [[127, 602], [127, 641], [127, 641], [203, 680]]}]});
    const ensureD3 = (cb) => {
...
<script>
  (() => {
    const SPEC = ({"title": "", "ariaLabel": "", "width": 612, "height": 612, "legendTitle": "Legend", "hint": "Hover a node to trace its connections.", "groups": [], "nodes": [{"id": "A", "x": 216, "y": 24, "w": 128, "h": 46, "title": "Input Sequence"}, {"id": "B", "x": 220, "y": 148, "w": 120, "h": 46, "title": "MoE Router"}, {"id": "C", "x": 460, "y": 272, "w": 120, "h": 46, "title": "Expert 1"}, {"id": "D", "x": 285, "y": 272, "w": 120, "h": 46, "title": "Expert 2"}, {"id": "E", "x": 110, "y": 272, "w": 120, "h": 46, "title": "Expert N"}, {"id": "F", "x": 239, "y": 410, "w": 212, "h": 46, "title": "Sequence-level Aggregation"}, {"id": "G", "x": 130, "y": 534, "w": 156, "h": 46, "title": "GSPO Policy Update"}], "edges": [{"src": "A", "dst": "B", "kind": "data", "line": [280, 70, 280, 148]}, {"src": "B", "dst": "C", "kind": "data", "curve": [[340, 187], [520, 233], [520, 233], [520, 272]]}, {"src": "B", "dst": "D", "kind": "data", "curve": [[304, 194], [345, 233], [345, 233], [345, 272]]}, {"src": "B", "dst": "E", "kind": "data", "curve": [[239, 194], [170, 233], [170, 233], [170, 272]]}, {"src": "C", "dst": "F", "kind": "data", "curve": [[520, 318], [520, 364], [520, 364], [403, 410]]}, {"src": "D", "dst": "F", "kind": "data", "line": [345, 318, 345, 410]}, {"src": "E", "dst": "F", "kind": "data", "curve": [[170, 318], [170, 364], [170, 364], [286, 410]]}, {"src": "F", "dst": "G", "kind": "data", "curve": [[345, 456], [345, 495], [345, 495], [259, 534]]}, {"src": "G", "dst": "B", "kind": "data", "label": "Stable Gradient", "curve": [[158, 534], [72, 433], [72, 295], [220, 189]], "off": "50%"}]});
    const ensureD3 = (cb) => {
      if (window.d3 && typeof window.d3.select === 'function') return cb();
      let s = document.getElementById('d3-cdn-script');
      if (!s) {
...
<!--
  ...
  only authors the JSON spec (content). See references/spec-schema.md.
-->
<div class="d3-arch" data-arch-root id="zationcomprehensiveguide-3"></div>
<style>
  /* ---- Theme tokens (standalone; light default + dark override) ---- */
  .d3-arch {
    --page-bg: #ffffff;
...
<script>
  (() => {
    const SPEC = ({"title": "", "ariaLabel": "", "width": 725, "height": 474, "legendTitle": "Legend", "hint": "Hover a node to trace its connections.", "groups": [], "nodes": [{"id": "A", "x": 295, "y": 24, "w": 142, "h": 46, "title": "Qwen3 Base Model"}, {"id": "B", "x": 305, "y": 148, "w": 121, "h": 46, "title": "GSPO Training"}, {"id": "C", "x": 537, "y": 272, "w": 128, "h": 46, "title": "Qwen3-Instruct"}, {"id": "D", "x": 306, "y": 272, "w": 120, "h": 46, "title": "Qwen3-Coder"}, {"id": "E", "x": 59, "y": 272, "w": 128, "h": 46, "title": "Qwen3-Thinking"}, {"id": "F", "x": 509, "y": 396, "w": 184, "h": 46, "title": "Improved General Tasks"}, {"id": "G", "x": 277, "y": 396, "w": 177, "h": 46, "title": "Improved Coding Tasks"}, {"id": "H", "x": 24, "y": 396, "w": 198, "h": 46, "title": "Improved Reasoning Tasks"}], "edges": [{"src": "A", "dst": "B", "kind": "data", "line": [366, 70, 366, 148]}, {"src": "B", "dst": "C", "kind": "data", "curve": [[426, 187], [601, 233], [601, 233], [601, 272]]}, {"src": "B", "dst": "D", "kind": "data", "line": [366, 194, 366, 272]}, {"src": "B", "dst": "E", "kind": "data", "curve": [[305, 186], [123, 233], [123, 233], [123, 272]]}, {"src": "C", "dst": "F", "kind": "data", "line": [601, 318, 601, 396]}, {"src": "D", "dst": "G", "kind": "data", "line": [366, 318, 366, 396]}, {"src": "E", "dst": "H", "kind": "data", "line": [123, 318, 123, 396]}]});
    const ensureD3 = (cb) => {
      if (window.d3 && typeof window.d3.select === 'function') return cb();
      let s = document.getElementById('d3-cdn-script');
      if (!s) {
    ...
    const bootstrap = () => {
      const container = document.getElementById('zationcomprehensiveguide-3')
        || document.querySelector('.d3-arch[data-arch-root]:not([data-mounted])');
      if (!container || (container.dataset && container.dataset.mounted === 'true')) return;
      if (container.dataset) container.dataset.mounted = 'true';

      try {
        const uid = 'zationcomprehensiveguide-3';
        const NODES = SPEC.nodes || [];
        const EDGES = SPEC.edges || [];
        const GROUPS = SPEC.groups || [];
        const HOP = SPEC.hop || 800;
