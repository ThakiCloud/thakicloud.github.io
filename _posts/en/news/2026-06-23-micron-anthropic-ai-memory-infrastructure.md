...
![AI inference server memory hierarchy: HBM is closest to the GPU and is the fastest bottleneck point]({{ '/assets/images/micron-anthropic-ai-memory-infrastructure-diagram.webp' | relative_url }})
