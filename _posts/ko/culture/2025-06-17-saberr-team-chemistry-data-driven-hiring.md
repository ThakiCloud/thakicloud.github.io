...
- [Schwartz 기본 가치 이론](https://en.wikipedia.org/wiki/Theory_of_basic_human_values) - 가치·동기 설문의 이론적 토대
- [Belbin 팀 역할 모델](https://www.belbin.com/about/belbin-team-roles) - 행동 다양성 차트의 근거
- [Big Five 성격 모델](https://en.wikipedia.org/wiki/Big_Five_personality_traits)
