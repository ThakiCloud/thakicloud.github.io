...
![가느다란 실이 투명한 문을 지나 눈과 손 모양 기호를 거쳐 세워진 화면 패널에 닿는 추상 이미지](/assets/images/phone-harness-agent-ios-hero.png)
...
![조작 함수보다 상태 확인과 종료 판단 함수에 더 많은 비중이 실려 있음을 보여주는 슬라이드](/assets/images/phone-harness-agent-ios-slide-04.png)
...
![존재하지 않는 패키지 이름과 실제 해결책, 그리고 점검기가 이를 잡지 못하는 이유를 정리한 슬라이드](/assets/images/phone-harness-agent-ios-slide-06.png)
...
![6개 점검 중 2개는 코드가 통과시키고 4개는 사람만 풀 수 있음을 보여주는 가로 막대 그래프](/assets/images/phone-harness-agent-ios-results.png)
...
![네 가지 실패가 버그가 아니라 사람의 물리적 행동으로만 풀리도록 설계된 제약임을 보여주는 슬라이드](/assets/images/phone-harness-agent-ios-slide-07.png)
