...
![사람이 남긴 손그림 궤적이 오른쪽으로 가면서 정연한 격자 구조로 결정화되는 추상 이미지](/assets/images/microsoft-skill-recorder-hero.png)
...
![수집, 복원, 계획 및 승인, 산출의 네 단계를 좌에서 우로 배열하고 각 단계의 역할을 설명한 슬라이드](/assets/images/microsoft-skill-recorder-slide-03.png)
...
![프레임 예산 약 5장, 의도 기반 노이즈 제거, 100% 로컬 전사라는 세 가지 설계 원칙을 카드로 정리한 슬라이드](/assets/images/microsoft-skill-recorder-slide-04.png)
...
![미문서화 암묵지 유입, 결정론적 도구로의 번역, 확신도로 낮추는 검토 비용, 어댑터 패턴 통합의 네 가지 시사점을 정리한 슬라이드](/assets/images/microsoft-skill-recorder-slide-05.png)
...
![데스크톱 종속성과 권한, 변수 추론의 본질적 한계, 비효율적 프로세스의 고착화라는 세 가지 한계를 정리한 슬라이드](/assets/images/microsoft-skill-recorder-slide-06.png)
