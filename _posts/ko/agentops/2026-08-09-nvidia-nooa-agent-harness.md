...
![중앙의 푸른 다면체 하나가 살아 있고 가느다란 실만 바깥의 작은 패널들로 뻗어 나가는 이미지](/assets/images/nvidia-nooa-agent-harness-hero.png)
...
![타입 지정 입출력, 참조 전달, 행동으로서의 코드, 명시적 객체 상태를 네 칸으로 정리한 슬라이드](/assets/images/nvidia-nooa-agent-harness-slide-04.png)
...
![파드 수가 늘어도 프리뷰 토큰은 700 근처에서 평평하고 전체 직렬화는 20만 토큰을 넘는 그래프](/assets/images/nvidia-nooa-agent-harness-results.png)
...
![코드 조각별 AST 검사기 판정을 정리하고 컨테인먼트 경계는 OS 수준이어야 한다고 결론짓는 슬라이드](/assets/images/nvidia-nooa-agent-harness-slide-07.png)
...
![Paxis, Signum, Aegis, Metis 각각에 대한 적용 시사점을 네 칸으로 정리한 슬라이드](/assets/images/nvidia-nooa-agent-harness-slide-08.png)
...
![성숙도 한계 인식, 워크로드 성격 파악, 병목 툴 부분 전환의 세 단계를 정리한 슬라이드](/assets/images/nvidia-nooa-agent-harness-slide-09.png)
