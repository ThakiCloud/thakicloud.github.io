...
![주황색 기하학 격자선이 겹쳐진 석상 두상과 AI 에이전트 하네스 설계 제목 텍스트](/assets/images/ai-agent-harness-design-slide-01.webp)
...
![사방으로 뻗은 화살표와 통로를 통과하는 단일 화살표로 통제된 방향성을 비교한 다이어그램](/assets/images/ai-agent-harness-design-slide-02.webp)
...
![출력 형식 요동, 도구 선택 변덕, 회복 불능의 3가지 파편화 증상을 정리한 인포그래픽](/assets/images/ai-agent-harness-design-slide-03.webp)
...
![검은색과 주황색으로 양분된 원형 그래픽과 시스템 프롬프트 계약 원칙 설명 텍스트](/assets/images/ai-agent-harness-design-slide-04.webp)
