...
![검증된 스킬을 소형 워커로 증류하는 하이브리드 구조. 스킬 플릿에서 스킬별 전문 교사, 온폴리시 증류, 소형 로컬 워커로 이어지는 4단계와 컨덕터는 남기고 워커만 내리는 하이브리드 라우팅, 회고 기반 에스컬레이션을 요약한 도식](/assets/images/distill-skill-fleet-small-models-diagram.svg)
