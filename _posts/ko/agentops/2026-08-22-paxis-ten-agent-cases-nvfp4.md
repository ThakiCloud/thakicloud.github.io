...
- [ThakiCloud/Qwen3.8-27B-NVFP4-FP8ATTN 모델 카드 (Hugging Face)](https://huggingface.co/ThakiCloud/Qwen3.8-27B-NVFP4-FP8ATTN)
- [Claude Opus 5 출시 및 API 가격 (Anthropic)](https://www.anthropic.com/news/claude-opus-5)
- [Claude Sonnet 5 API 가격 (Anthropic)](https://www.anthropic.com/news/claude-sonnet-5)
- [OpenAI API 가격표 (gpt-5.6 sol/terra 단기·장기 컨텍스트)](https://developers.openai.com/api/docs/pricing)
- [NVFP4: NVIDIA Blackwell 4bit 부동소수 포맷 (TensorRT 문서)](https://docs.nvidia.com/deeplearning/tensorrt/latest/architecture/fp4.html)
