...
![물 위에 나란히 선 동일한 유리 판들 가운데 하나에만 빛이 비치고, 앞쪽 물에는 끊어진 케이블이 떠 있는 추상 이미지](/assets/images/mcp-2026-07-28-stateless-hero.png)
...
![핸드셰이크 제거, 헤더 기반 라우팅, MRTR 패턴, 목록 응답 캐싱 네 가지 변경점을 정리한 슬라이드](/assets/images/mcp-2026-07-28-stateless-slide-05.png)
...
![스키마 변경량과 무상태 관련 필드 등장 횟수를 비교한 이중 막대 차트](/assets/images/mcp-2026-07-28-stateless-results.png)
...
![sticky session 인그레스가 제거되고 요청이 여러 K8s 파드로 자유롭게 분산되는 모습을 그린 슬라이드](/assets/images/mcp-2026-07-28-stateless-slide-08.png)
...
![아키텍처 제약과 마이그레이션 부채를 나란히 정리한 슬라이드](/assets/images/mcp-2026-07-28-stateless-slide-09.png)
