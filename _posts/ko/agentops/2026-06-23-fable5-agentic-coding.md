...
![에이전트형 코딩 개념 이미지]({{ '/assets/images/fable5-agentic-coding-hero.webp' | relative_url }})
...
![에이전트형 코딩의 자율 루프]({{ '/assets/images/fable5-agentic-coding-diagram.svg' | relative_url }})

*에이전트형 코딩의 자율 루프: 사람이 의도를 주면 에이전트가 계획·작성·테스트·자가검증을 반복하고, 통과 시 변경을 제출하며 사람은 방향을 검토한다*
