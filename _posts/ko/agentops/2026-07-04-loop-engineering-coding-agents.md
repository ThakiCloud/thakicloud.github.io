...
toc_label: "목차"
toc_icon: "robot"
canonical_url: "https://thakicloud.github.io/ko/agentops/loop-engineering-coding-agents/"
categories:
  - agentops
---
...
![코딩 에이전트 루프 엔지니어링 개념 이미지](/assets/images/loop-engineering-coding-agents-hero.webp)
...
![프롬프트 방식의 선형 병목과 루프 엔지니어링의 순환 구조 비교](/assets/images/loop-engineering-coding-agents-slide-02.webp)
...
![자기 보고의 함정과 결정론적 보상 신호, pge-loop와 fan-out 검증](/assets/images/loop-engineering-coding-agents-slide-04.webp)
...
![관찰·판단·실행 루프를 Paxis 제어 평면과 ai-platform 리소스로 매핑한 아키텍처](/assets/images/loop-engineering-coding-agents-slide-05.webp)
...
![예산 상한과 워커·게이트 모델 라우팅, 루프 한계점 3원칙](/assets/images/loop-engineering-coding-agents-slide-06.webp)
