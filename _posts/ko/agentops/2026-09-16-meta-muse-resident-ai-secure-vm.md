...
excerpt: "메타는 앱을 껐어도 계속 일하는 상주형 AI를 내놓았다. 사람마다 하나씩 배정되는 전용 가상 컴퓨터, 그리고 따로 둔 수호자 에이전트. 그런데 내부 테스트 자료에는 작업 중 멈춤과 민감정보 노출이 기록되어 있었다. 소비자 버전은 형태를 증명했고, 기업 버전은 아직 풀리지 않은 질문이다."
seo_title: "사람마다 PC 한 대씩을 준 메타, 상주형 AI 뮤즈의 해부학"
seo_description: "9월 8일 공개된 메타의 개인 AI 에이전트 뮤즈는 앱을 닫은 뒤에도 백그라운드에서 다단계 업무를 이어간다. 시큐어 VM과 센티넬 구조, 시장 반응, 그리고 내부 테스트가 드러낸 신뢰 격차를 분석하고 기업 에이전트 도입에 어떤 신호가 되는지 짚어본다."
date: 2026-09-16
