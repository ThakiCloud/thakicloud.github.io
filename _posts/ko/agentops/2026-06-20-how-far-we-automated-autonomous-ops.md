...
<script>
  (() => {
    const SPEC = ({"title": "", "ariaLabel": "", "width": 212, "height": 662, "legendTitle": "Legend", "hint": "Hover a node to trace its connections.", "groups": [], "nodes": [{"id": "A", "x": 42, "y": 24, "w": 120, "h": 46, "title": "새 트랜스크립트"}, {"id": "B", "x": 38, "y": 148, "w": 128, "h": 62, "title": ["23:00 결정론 ($0)", "추출·감쇠·고아·아카이브"]}, {"id": "C", "x": 42, "y": 288, "w": 120, "h": 62, "title": ["23:30 LLM 판단", "주제 통합·선호 승격"]}, {"id": "D", "x": 24, "y": 428, "w": 156, "h": 62, "title": ["memory/topics", "memory/preferences"]}, {"id": "E", "x": 42, "y": 568, "w": 120, "h": 62, "title": ["다음 세션에", "컨텍스트로 주입"]}], "edges": [{"src": "A", "dst": "B", "kind": "data", "line": [102, 70, 102, 148]}, {"src": "B", "dst": "C", "kind": "data", "line": [102, 210, 102, 288]}, {"src": "C", "dst": "D", "kind": "data", "line": [102, 350, 102, 428]}, {"src": "D", "dst": "E", "kind": "data", "line": [102, 490, 102, 568]}]});
    const ensureD3 = (cb) => {
      if (window.d3 && typeof window.d3.select === 'function') return cb();
      let s = document.getElementById('d3-cdn-script');
      if (!s) {
