...
![Awesome Public Datasets 카테고리 구성 개요]({{ '/assets/images/awesome-public-datasets-comprehensive-guide-ko-hero.webp' | relative_url }})
...
-->
<div class="d3-arch" data-arch-root id="setscomprehensiveguideko-1"></div>
<style>
...
<script>
  (() => {
    ...
    const bootstrap = () => {
      const container = document.getElementById('setscomprehensiveguideko-1')
        || document.querySelector('.d3-arch[data-arch-root]:not([data-mounted])');
      if (!container || (container.dataset && container.dataset.mounted === 'true')) return;
      if (container.dataset) container.dataset.mounted = 'true';

      try {
        const uid = 'setscomprehensiveguideko-1';
