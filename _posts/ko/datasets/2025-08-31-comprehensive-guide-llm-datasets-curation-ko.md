...
- [mlabonne/llm-datasets - 후훈련 데이터셋·도구 큐레이션 목록 (GitHub)](https://github.com/mlabonne/llm-datasets)
- [Distilabel - 합성 데이터·AI 피드백 프레임워크](https://github.com/argilla-io/distilabel)
- [Argilla - 데이터셋 협업·주석 플랫폼](https://github.com/argilla-io/argilla)
- [Trafilatura - 웹 텍스트·메타데이터 추출](https://github.com/adbar/trafilatura)
