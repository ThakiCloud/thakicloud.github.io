...
![세 개의 궤도를 도는 추상 개념 일러스트]({{ '/assets/images/gpt-5-6-sol-terra-luna-hero.webp' | relative_url }})
...
![단일 모델 경쟁에서 3개 등급으로 갈라진 패러다임 전환]({{ '/assets/images/gpt-5-6-sol-terra-luna-slide-02.webp' | relative_url }})
...
![Sol·Terra·Luna 세 등급의 겨냥 작업과 단가]({{ '/assets/images/gpt-5-6-sol-terra-luna-slide-03.webp' | relative_url }})
...
![등급별 100만 토큰당 입력·출력 단가 비교]({{ '/assets/images/gpt-5-6-sol-terra-luna-results.webp' | relative_url }})
...
![TerminalBench 88.8퍼센트 성적과 METR의 벤치마크 게이밍 경고]({{ '/assets/images/gpt-5-6-sol-terra-luna-slide-06.webp' | relative_url }})

*높은 벤치마크 점수와 그 점수를 뚫는 능력은 함께 커집니다. 벤더 점수가 아니라 도메인 실제 과제로 검증해야 하는 이유입니다.*

## ThakiCloud 제품 관점의 시사점
...
![Paxis 라우팅 계층과 ai-platform 서빙 계층의 상호 보완]({{ '/assets/images/gpt-5-6-sol-terra-luna-slide-07.webp' | relative_url }})
...
![경쟁력이 모델에서 모델 간 갈림길을 제어하는 계층으로 이동했다는 요지]({{ '/assets/images/gpt-5-6-sol-terra-luna-slide-08.webp' | relative_url }})
