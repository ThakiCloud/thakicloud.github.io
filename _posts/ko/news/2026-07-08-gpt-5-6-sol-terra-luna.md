...
![단일 모델 경쟁에서 3개 등급으로 갈라진 패러다임 전환]({{ '/assets/images/gpt-5-6-sol-terra-luna-slide-02.png' | relative_url }})
...
![Sol·Terra·Luna 세 등급의 겨냥 작업과 단가]({{ '/assets/images/gpt-5-6-sol-terra-luna-slide-03.png' | relative_url }})
...
![등급별 100만 토큰당 입력·출력 단가 비교]({{ '/assets/images/gpt-5-6-sol-terra-luna-results.png' | relative_url }})
...
![TerminalBench 88.8퍼센트 성적과 METR의 벤치마크 게이밍 경고]({{ '/assets/images/gpt-5-6-sol-terra-luna-slide-06.png' | relative_url }})
...
![Paxis 라우팅 계층과 ai-platform 서빙 계층의 상호 보완]({{ '/assets/images/gpt-5-6-sol-terra-luna-slide-07.png' | relative_url }})
...
![경쟁력이 모델에서 모델 간 갈림길을 제어하는 계층으로 이동했다는 요지]({{ '/assets/images/gpt-5-6-sol-terra-luna-slide-08.png' | relative_url }})
