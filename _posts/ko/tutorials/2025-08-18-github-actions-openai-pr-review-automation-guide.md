...
toc_icon: "cog"
toc_sticky: true
canonical_url: "https://thakicloud.com/tech-blog/tutorials/github-actions-openai-pr-review-automation-guide/"
reading_time: true
published: false
categories:
  - tutorials
...
-->
<div class="d3-arch" data-arch-root id="iprreviewautomationguide-1"></div>
<style>
...
<script>
  (() => {
    const SPEC = ({"title": "", "ariaLabel": "", "width": 362, "height": 990, "legendTitle": "Legend", "hint": "Hover a node to trace its connections.", "groups": [], "nodes": [{"id": "A", "x": 112, "y": 24, "w": 120, "h": 46, "title": "PR 생성/업데이트"}, {"id": "B", "x": 94, "y": 148, "w": 156, "h": 46, "title": "GitHub Actions 트리거"}, {"id": "C", "x": 112, "y": 272, "w": 120, "h": 46, "title": "Python 환경 설정"}, {"id": "D", "x": 112, "y": 396, "w": 120, "h": 46, "title": "PR 룰 검증"}, {"id": "E", "x": 103, "y": 520, "w": 138, "h": 52, "title": "PR 룰 통과?"}, {"id": "F", "x": 188, "y": 664, "w": 142, "h": 46, "title": "OpenAI API 코드 리뷰"}, {"id": "G", "x": 24, "y": 788, "w": 120, "h": 46, "title": "PR 룰 위반 코멘트"}, {"id": "H", "x": 199, "y": 788, "w": 120, "h": 46, "title": "리뷰 결과 PR 코멘트"}, {"id": "I", "x": 112, "y": 912, "w": 120, "h": 46, "title": "PR 상태 업데이트"}], "edges": [{"src": "A", "dst": "B", "kind": "data", "line": [172, 70, 172, 148]}, {"src": "B", "dst": "C", "kind": "data", "line": [172, 194, 172, 272]}, {"src": "C", "dst": "D", "kind": "data", "line": [172, 318, 172, 396]}, {"src": "D", "dst": "E", "kind": "data", "line": [172, 442, 172, 520]}, {"src": "E", "dst": "F", "kind": "data", "label": "Yes", "curve": [[203, 572], [259, 618], [259, 618], [259, 664]], "off": "50%"}, {"src": "E", "dst": "G", "kind": "data", "label": "No", "curve": [[140, 572], [84, 618], [84, 749], [84, 788]], "off": "50%"}, {"src": "F", "dst": "H", "kind": "data", "line": [259, 710, 259, 788]}, {"src": "G", "dst": "I", "kind": "data", "curve": [[84, 834], [84, 873], [84, 873], [139, 912]]}, {"src": "H", "dst": "I", "kind": "data", "curve": [[259, 834], [259, 873], [259, 873], [204, 912]]}]});
    const ensureD3 = (cb) => {
    ...
    const bootstrap = () => {
      const container = document.getElementById('iprreviewautomationguide-1')
        || document.querySelector('.d3-arch[data-arch-root]:not([data-mounted])');
      if (!container || (container.dataset && container.dataset.mounted === 'true')) return;
      if (container.dataset) container.dataset.mounted = 'true';

      try {
        const uid = 'iprreviewautomationguide-1';
