...
toc_icon: "cog"
toc_sticky: true
canonical_url: "https://thakicloud.com/tech-blog/tutorials/sim-studio-ollama-enterprise-ai-platform-guide/"
reading_time: true
published: false
categories:
  - tutorials
...
-->
<div class="d3-arch" data-arch-root id="nterpriseaiplatformguide-1"></div>
<style>
...
<script>
  (() => {
    const SPEC = ({"title": "", "ariaLabel": "", "width": 176, "height": 1094, "legendTitle": "Legend", "hint": "Hover a node to trace its connections.", "groups": [], "nodes": [{"id": "A", "x": 24, "y": 24, "w": 120, "h": 46, "title": "클라이언트 브리프"}, {"id": "B", "x": 24, "y": 148, "w": 120, "h": 46, "title": "브랜드 톤앤매너 분석"}, {"id": "C", "x": 24, "y": 272, "w": 120, "h": 46, "title": "키워드 리서치"}, {"id": "D", "x": 24, "y": 396, "w": 120, "h": 46, "title": "콘텐츠 아이디어 생성"}, {"id": "E", "x": 24, "y": 520, "w": 120, "h": 46, "title": "초안 작성"}, {"id": "F", "x": 24, "y": 644, "w": 120, "h": 46, "title": "SEO 최적화"}, {"id": "G", "x": 24, "y": 768, "w": 120, "h": 46, "title": "이미지 생성 프롬프트"}, {"id": "H", "x": 24, "y": 892, "w": 120, "h": 46, "title": "최종 검토"}, {"id": "I", "x": 24, "y": 1016, "w": 120, "h": 46, "title": "클라이언트 승인"}], "edges": [{"src": "A", "dst": "B", "kind": "data", "line": [84, 70, 84, 148]}, {"src": "B", "dst": "C", "kind": "data", "line": [84, 194, 84, 272]}, {"src": "C", "dst": "D", "kind": "data", "line": [84, 318, 84, 396]}, {"src": "D", "dst": "E", "kind": "data", "line": [84, 442, 84, 520]}, {"src": "E", "dst": "F", "kind": "data", "line": [84, 566, 84, 644]}, {"src": "F", "dst": "G", "kind": "data", "line": [84, 690, 84, 768]}, {"src": "G", "dst": "H", "kind": "data", "line": [84, 814, 84, 892]}, {"src": "H", "dst": "I", "kind": "data", "line": [84, 938, 84, 1016]}]});
    const ensureD3 = (cb) => {
    ...
    const bootstrap = () => {
      const container = document.getElementById('nterpriseaiplatformguide-1')
        || document.querySelector('.d3-arch[data-arch-root]:not([data-mounted])');
      if (!container || (container.dataset && container.dataset.mounted === 'true')) return;
      if (container.dataset) container.dataset.mounted = 'true';

      try {
        const uid = 'nterpriseaiplatformguide-1';
