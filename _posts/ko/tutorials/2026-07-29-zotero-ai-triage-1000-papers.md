...
![겹겹이 쌓인 종이 더미 가운데 한 장만 빛을 받아 떠오르는 추상 이미지](/assets/images/zotero-ai-triage-1000-papers-hero.png)
...
![대상 독자와 핵심 질문을 정리한 슬라이드](/assets/images/zotero-ai-triage-1000-papers-slide-02.png)
...
![측정 환경과 표본을 정리한 슬라이드](/assets/images/zotero-ai-triage-1000-papers-slide-04.png)
...
![논문 10편의 추출 시간과 1,000편 환산 소요 시간을 비교한 막대 그래프](/assets/images/zotero-ai-triage-1000-papers-results.png)
...
![5분 안에 처리하려면 초당 81,266토큰이 필요하다는 슬라이드](/assets/images/zotero-ai-triage-1000-papers-slide-06.png)
...
![스크리닝 후 상위 20편만 읽으면 워크로드가 50분의 1로 줄어든다는 슬라이드](/assets/images/zotero-ai-triage-1000-papers-slide-10.png)
...
![OCR 병목, 스크리닝 맹점, 토큰 추정 오차를 정리한 슬라이드](/assets/images/zotero-ai-triage-1000-papers-slide-12.png)
