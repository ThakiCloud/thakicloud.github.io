...
canonical_url: "https://thakicloud.com/tech-blog/ko/tutorials/designing-agentic-loops-complete-tutorial/"
categories:
  - tutorials
---
...
-->
<div class="d3-arch" data-arch-root id="cloopscompletetutorialko-1"></div>
<style>
...
<script>
  (() => {
    const SPEC = ({"title": "", "ariaLabel": "", "width": 239, "height": 742, "legendTitle": "Legend", "hint": "Hover a node to trace its connections.", "groups": [], "nodes": [{"id": "A", "x": 33, "y": 24, "w": 120, "h": 46, "title": "목표 정의"}, {"id": "B", "x": 33, "y": 148, "w": 120, "h": 46, "title": "도구 선택"}, {"id": "C", "x": 33, "y": 272, "w": 120, "h": 46, "title": "작업 실행"}, {"id": "D", "x": 87, "y": 396, "w": 120, "h": 46, "title": "결과 평가"}, {"id": "E", "x": 24, "y": 520, "w": 138, "h": 52, "title": "목표 달성?"}, {"id": "F", "x": 33, "y": 664, "w": 120, "h": 46, "title": "성공"}], "edges": [{"src": "A", "dst": "B", "kind": "data", "line": [93, 70, 93, 148]}, {"src": "B", "dst": "C", "kind": "data", "line": [93, 194, 93, 272]}, {"src": "C", "dst": "D", "kind": "data", "curve": [[113, 318], [147, 357], [147, 357], [147, 396]]}, {"src": "D", "dst": "E", "kind": "data", "curve": [[147, 442], [147, 481], [147, 481], [114, 520]]}, {"src": "E", "dst": "C", "kind": "data", "label": "아니오", "curve": [[72, 520], [39, 481], [39, 357], [73, 318]], "off": "50%"}, {"src": "E", "dst": "F", "kind": "data", "label": "예", "line": [93, 572, 93, 664], "lx": 93, "ly": 614}]});
    const ensureD3 = (cb) => {
    ...
    const bootstrap = () => {
      const container = document.getElementById('cloopscompletetutorialko-1')
        || document.querySelector('.d3-arch[data-arch-root]:not([data-mounted])');
      if (!container || (container.dataset && container.dataset.mounted === 'true')) return;
      if (container.dataset) container.dataset.mounted = 'true';

      try {
        const uid = 'cloopscompletetutorialko-1';
