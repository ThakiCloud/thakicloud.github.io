...
-->
<div class="d3-arch" data-arch-root id="backendframeworktutorial-1"></div>
<style>
...
<script>
  (() => {
    const SPEC = ({"title": "", "ariaLabel": "", "width": 604, "height": 722, "legendTitle": "Legend", "hint": "Hover a node to trace its connections.", "groups": [], "nodes": [{"id": "A", "x": 156, "y": 24, "w": 128, "h": 46, "title": "GitHub Webhook"}, {"id": "B", "x": 124, "y": 148, "w": 191, "h": 46, "title": "webhook-handler.step.js"}, {"id": "C", "x": 149, "y": 272, "w": 142, "h": 46, "title": "Event: pr-opened"}, {"id": "D", "x": 249, "y": 396, "w": 163, "h": 46, "title": "code-review.step.js"}, {"id": "E", "x": 24, "y": 396, "w": 170, "h": 46, "title": "notification.step.js"}, {"id": "F", "x": 235, "y": 520, "w": 191, "h": 46, "title": "Event: review-completed"}, {"id": "G", "x": 242, "y": 644, "w": 177, "h": 46, "title": "merge-handler.step.js"}, {"id": "H", "x": 360, "y": 24, "w": 212, "h": 46, "title": "Cron: daily-report.step.js"}, {"id": "I", "x": 370, "y": 148, "w": 191, "h": 46, "title": "Event: report-generated"}, {"id": "J", "x": 360, "y": 272, "w": 212, "h": 46, "title": "slack-notification.step.js"}], "edges": [{"src": "A", "dst": "B", "kind": "data", "line": [220, 70, 220, 148]}, {"src": "B", "dst": "C", "kind": "data", "line": [220, 194, 220, 272]}, {"src": "C", "dst": "D", "kind": "data", "curve": [[261, 318], [331, 357], [331, 357], [331, 396]]}, {"src": "C", "dst": "E", "kind": "data", "curve": [[179, 318], [109, 357], [109, 357], [109, 396]]}, {"src": "D", "dst": "F", "kind": "data", "line": [331, 442, 331, 520]}, {"src": "F", "dst": "G", "kind": "data", "line": [331, 566, 331, 644]}, {"src": "H", "dst": "I", "kind": "data", "line": [466, 70, 466, 148]}, {"src": "I", "dst": "J", "kind": "data", "line": [466, 194, 466, 272]}]});
    const ensureD3 = (cb) => {
    ...
    const bootstrap = () => {
      const container = document.getElementById('backendframeworktutorial-1')
        || document.querySelector('.d3-arch[data-arch-root]:not([data-mounted])');
      if (!container || (container.dataset && container.dataset.mounted === 'true')) return;
      if (container.dataset) container.dataset.mounted = 'true';

      try {
        const uid = 'backendframeworktutorial-1';
...
<!--
  ...
  only authors the JSON spec (content). See references/spec-schema.md.
-->
<div class="d3-arch" data-arch-root id="backendframeworktutorial-2"></div>
<style>
  /* ---- Theme tokens (standalone; light default + dark override) ---- */
  .d3-arch {
    --page-bg: #ffffff;
...
<script>
  (() => {
    const SPEC = ({"title": "", "ariaLabel": "", "width": 637, "height": 738, "legendTitle": "Legend", "hint": "Hover a node to trace its connections.", "groups": [], "nodes": [{"id": "A", "x": 196, "y": 32, "w": 121, "h": 46, "title": "Gmail Webhook"}, {"id": "B", "x": 161, "y": 164, "w": 191, "h": 46, "title": "email-processor.step.js"}, {"id": "C", "x": 168, "y": 288, "w": 177, "h": 46, "title": "Event: email-received"}, {"id": "D", "x": 298, "y": 412, "w": 163, "h": 46, "title": "spam-filter.step.js"}, {"id": "E", "x": 24, "y": 412, "w": 219, "h": 46, "title": "priority-classifier.step.js"}, {"id": "F", "x": 295, "y": 536, "w": 170, "h": 46, "title": "Event: spam-detected"}, {"id": "G", "x": 49, "y": 536, "w": 170, "h": 46, "title": "Event: high-priority"}, {"id": "H", "x": 24, "y": 660, "w": 219, "h": 46, "title": "urgent-notification.step.js"}, {"id": "I", "x": 418, "y": 24, "w": 177, "h": 62, "title": ["Cron:", "daily-cleanup.step.js"]}, {"id": "J", "x": 407, "y": 164, "w": 198, "h": 46, "title": "Event: cleanup-completed"}, {"id": "K", "x": 407, "y": 288, "w": 198, "h": 46, "title": "report-generator.step.js"}], "edges": [{"src": "A", "dst": "B", "kind": "data", "line": [257, 78, 257, 164]}, {"src": "B", "dst": "C", "kind": "data", "line": [257, 210, 257, 288]}, {"src": "C", "dst": "D", "kind": "data", "curve": [[302, 334], [380, 373], [380, 373], [380, 412]]}, {"src": "C", "dst": "E", "kind": "data", "curve": [[211, 334], [134, 373], [134, 373], [134, 412]]}, {"src": "D", "dst": "F", "kind": "data", "line": [380, 458, 380, 536]}, {"src": "E", "dst": "G", "kind": "data", "line": [134, 458, 134, 536]}, {"src": "G", "dst": "H", "kind": "data", "line": [134, 582, 134, 660]}, {"src": "I", "dst": "J", "kind": "data", "line": [506, 86, 506, 164]}, {"src": "J", "dst": "K", "kind": "data", "line": [506, 210, 506, 288]}]});
    const ensureD3 = (cb) => {
      if (window.d3 && typeof window.d3.select === 'function') return cb();
      let s = document.getElementById('d3-cdn-script');
      if (!s) {
    ...
    const bootstrap = () => {
      const container = document.getElementById('backendframeworktutorial-2')
        || document.querySelector('.d3-arch[data-arch-root]:not([data-mounted])');
      if (!container || (container.dataset && container.dataset.mounted === 'true')) return;
      if (container.dataset) container.dataset.mounted = 'true';

      try {
        const uid = 'backendframeworktutorial-2';
        const NODES = SPEC.nodes || [];
        const EDGES = SPEC.edges || [];
        const GROUPS = SPEC.groups || [];
        const HOP = SPEC.hop || 800;
