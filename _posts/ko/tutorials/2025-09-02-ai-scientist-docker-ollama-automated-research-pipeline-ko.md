...
toc_icon: "cog"
toc_sticky: true
canonical_url: "https://thakicloud.com/tech-blog/ko/tutorials/ai-scientist-docker-ollama-automated-research-pipeline/"
lang: ko
...
-->
<div class="d3-arch" data-arch-root id="omatedresearchpipelineko-1"></div>
<style>
...
<script>
  (() => {
    const SPEC = ({"title": "", "ariaLabel": "", "width": 176, "height": 1098, "legendTitle": "Legend", "hint": "Hover a node to trace its connections.", "groups": [], "nodes": [{"id": "A", "x": 24, "y": 24, "w": 120, "h": 62, "title": ["🎯 연구 아이디어", "생성"]}, {"id": "B", "x": 24, "y": 164, "w": 120, "h": 62, "title": ["🔬 실험", "설계"]}, {"id": "C", "x": 24, "y": 304, "w": 120, "h": 62, "title": ["⚙️ 코드", "구현"]}, {"id": "D", "x": 24, "y": 444, "w": 120, "h": 62, "title": ["🧪 실험", "실행"]}, {"id": "E", "x": 24, "y": 584, "w": 120, "h": 62, "title": ["📊 결과", "분석"]}, {"id": "F", "x": 24, "y": 724, "w": 120, "h": 62, "title": ["📝 논문", "작성"]}, {"id": "G", "x": 24, "y": 864, "w": 120, "h": 62, "title": ["📋 동료", "평가"]}, {"id": "H", "x": 24, "y": 1004, "w": 120, "h": 62, "title": ["📄 최종", "논문"]}], "edges": [{"src": "A", "dst": "B", "kind": "data", "line": [84, 86, 84, 164]}, {"src": "B", "dst": "C", "kind": "data", "line": [84, 226, 84, 304]}, {"src": "C", "dst": "D", "kind": "data", "line": [84, 366, 84, 444]}, {"src": "D", "dst": "E", "kind": "data", "line": [84, 506, 84, 584]}, {"src": "E", "dst": "F", "kind": "data", "line": [84, 646, 84, 724]}, {"src": "F", "dst": "G", "kind": "data", "line": [84, 786, 84, 864]}, {"src": "G", "dst": "H", "kind": "data", "line": [84, 926, 84, 1004]}]});
    const ensureD3 = (cb) => {
    ...
    const bootstrap = () => {
      const container = document.getElementById('omatedresearchpipelineko-1')
        || document.querySelector('.d3-arch[data-arch-root]:not([data-mounted])');
      if (!container || (container.dataset && container.dataset.mounted === 'true')) return;
      if (container.dataset) container.dataset.mounted = 'true';

      try {
        const uid = 'omatedresearchpipelineko-1';
