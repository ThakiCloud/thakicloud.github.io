...
BF16 원본의 MMLU가 0.7779인데, GPTQ 빌드는 0.7743으로 통계적으로 구분되지 않았습니다. 3.14배 작아진 4비트 모델이 원본과 같은 점수를 냅니다. 반면 RTN 빌드는 0.7676으로 약 1포인트를 잃었습니다. GPTQ가 더 쓴 시간은 5.4시간이고, 그 시간이 사는 것이 정확히 그 1포인트입니다.
