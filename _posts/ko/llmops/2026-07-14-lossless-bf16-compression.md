...
![Qwen2.5-0.5B 실측 결과. BF16 지수 필드가 실제로는 2.64비트만 쓰며, 이를 무손실로 압축하면 GLM-5.2 기준 1403GB가 약 980GB로 줄어든다는 것을 보여주는 차트]({{ '/assets/images/lossless-bf16-compression-results.webp' | relative_url }})
