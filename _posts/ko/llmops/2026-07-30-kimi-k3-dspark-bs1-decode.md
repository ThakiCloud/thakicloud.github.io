...
![느린 밀집 군집을 앞질러 나아가는 하나의 빛줄기와 병렬로 퍼졌다 합쳐지는 일곱 개의 불꽃을 그린 추상 이미지](/assets/images/kimi-k3-dspark-bs1-decode-hero.webp)
...
![수용률에 따른 bs=1 처리량 곡선과 공개 수치 앵커를 표시한 그래프](/assets/images/kimi-k3-dspark-bs1-decode-results.webp)
