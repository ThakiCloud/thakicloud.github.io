...
![빛의 실이 결정 구조를 통과하며 다시 짜이는 추상 이미지](/assets/images/minimax-h3-lora-recipe-not-weights-hero.png)
...
![베이스 모델 공개 직후 트레이너와 원클릭 실행 경로가 갖춰진 과정을 정리한 도식](/assets/images/minimax-h3-lora-recipe-not-weights-slide-02.png)
...
![슬로모션 리타이밍과 프레임레이트 정규화, 구조화 캡션으로 이어지는 3단계 전처리 도식](/assets/images/minimax-h3-lora-recipe-not-weights-slide-07.png)
...
![다섯 개 스윕 후보에서 사람의 비교 평가를 거쳐 최종 설정으로 좁혀지는 깔때기 도식](/assets/images/minimax-h3-lora-recipe-not-weights-slide-08.png)
...
![적용 제외 지역과 금지 행위, 그리고 호스티드 API만 남는 구조를 정리한 도식](/assets/images/minimax-h3-lora-recipe-not-weights-slide-04.png)
...
![라이선스에 묶인 자산과 이전 가능한 레시피를 좌우로 나눠 대조한 도식](/assets/images/minimax-h3-lora-recipe-not-weights-slide-05.png)
...
![추출한 레시피를 실행할 때 각 제품 계층이 맡는 역할을 정리한 도식](/assets/images/minimax-h3-lora-recipe-not-weights-slide-09.png)
