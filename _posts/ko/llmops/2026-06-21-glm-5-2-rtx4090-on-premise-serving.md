...
toc_icon: "cog"
toc_sticky: true
canonical_url: "https://thakicloud.com/tech-blog/ko/llmops/glm-5-2-rtx4090-on-premise-serving/"
reading_time: true
categories:
  - llmops
...
- GLM-5 모델 카드 (Zhipu AI / Z.ai, zai-org): <https://huggingface.co/zai-org/GLM-5>
- GLM-4.6 모델 카드 (이전 세대 참조): <https://huggingface.co/zai-org/GLM-4.6>
- GLM-4.5 / 4.6 / MoE 아키텍처 문서 (Hugging Face Transformers): <https://huggingface.co/docs/transformers/model_doc/glm4_moe>

> 본문의 RTX 4090 단일 구동 사례와 약 10 tok/s 처리량은 커뮤니티 보고에 근거한 **[추정]**이며, 독립적으로 검증된 공식 벤치마크가 아닙니다. DSA(희소 어텐션)는 GLM-5 계열에 통합된 것으로 공개 자료에서 확인되며, 특정 마이너 버전(5.2)의 세부 수치는 공식 모델 카드를 기준으로 합니다.
