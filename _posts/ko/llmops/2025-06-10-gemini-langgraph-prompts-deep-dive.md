...
-->
<div class="d3-arch" data-arch-root id="langgraphpromptsdeepdive-1"></div>
<style>
...
<script>
  (() => {
    const SPEC = ({"title": "", "ariaLabel": "", "width": 433, "height": 816, "legendTitle": "Legend", "hint": "Hover a node to trace its connections.", "groups": [], "nodes": [{"id": "A", "x": 134, "y": 24, "w": 121, "h": 46, "title": "User Question"}, {"id": "B", "x": 92, "y": 148, "w": 205, "h": 62, "title": ["Query Writer", "query_writer_instructions"]}, {"id": "C", "x": 196, "y": 288, "w": 205, "h": 62, "title": ["Web Searcher", "web_searcher_instructions"]}, {"id": "D", "x": 99, "y": 428, "w": 191, "h": 62, "title": ["Reflection", "reflection_instructions"]}, {"id": "E", "x": 113, "y": 582, "w": 163, "h": 62, "title": ["Answer Synthesis", "answer_instructions"]}, {"id": "F", "x": 120, "y": 722, "w": 149, "h": 62, "title": ["Final Answer with", "Citations"]}], "edges": [{"src": "A", "dst": "B", "kind": "data", "line": [195, 70, 195, 148]}, {"src": "B", "dst": "C", "kind": "data", "curve": [[241, 210], [298, 249], [298, 249], [298, 288]]}, {"src": "C", "dst": "D", "kind": "data", "curve": [[298, 350], [298, 389], [298, 389], [241, 428]]}, {"src": "D", "dst": "B", "kind": "data", "label": "is_sufficient = false", "curve": [[149, 428], [91, 389], [91, 249], [149, 210]], "off": "50%"}, {"src": "D", "dst": "E", "kind": "data", "label": "is_sufficient = true", "line": [195, 490, 195, 582], "lx": 195, "ly": 532}, {"src": "E", "dst": "F", "kind": "data", "line": [195, 644, 195, 722]}]});
    const ensureD3 = (cb) => {
    ...
    const bootstrap = () => {
      const container = document.getElementById('langgraphpromptsdeepdive-1')
        || document.querySelector('.d3-arch[data-arch-root]:not([data-mounted])');
      if (!container || (container.dataset && container.dataset.mounted === 'true')) return;
      if (container.dataset) container.dataset.mounted = 'true';

      try {
        const uid = 'langgraphpromptsdeepdive-1';
