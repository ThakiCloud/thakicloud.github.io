...
excerpt: "Qwen3.8-27B가 한국어로 답하다 문장 중간에 한자를 흘립니다. 원인을 쫓다 보니 오염률의 5배가 생성 온도 하나로 갈렸고, 결국 가중치에서 출력 경로를 막아 실제 오류를 1.81%에서 0.18%로 낮췄습니다. 한자 병기는 살렸습니다."
seo_title: "한국어 LLM 한자 혼입: 온도·DPO·어휘 가지치기 실측"
seo_description: "Qwen3.8-27B 한국어 응답의 CJK 혼입을 3,369 프롬프트로 측정했습니다. 온도가 5배를 좌우하고, lm_head 어휘 가지치기가 실오류를 1.81%에서 0.18%로 낮춥니다. 한자 병기는 보존됩니다."
date: 2026-09-01
published: true
categories:
  - llmops
...
`mu_h`는 한국어 문장들의 최종 은닉 상태 평균으로, 가정하지 않고 직접 측정했습니다. 두 번의 독립 측정에서 `||mu_h||²`가 약 9,846과 9,887로 0.4% 안에서 재현됐습니다.
...
한국어 문맥이 아니라 **코드와 CLI 문맥에서 하이픈이 와야 할 자리**입니다. 잠가 둔 글쇠가 어떤 상황에서는 눌려 버린 것입니다.
