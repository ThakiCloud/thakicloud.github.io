...
<script>
  (() => {
    const SPEC = ({"title": "", "ariaLabel": "", "width": 322, "height": 612, "legendTitle": "Legend", "legend": {"data": "Flow", "event": "Dotted / alternate path"}, "hint": "Hover a node to trace its connections.", "groups": [{"x": 24, "y": 148, "w": 266, "h": 294, "label": "RL 스텝 (2단계)", "lx": 36, "ly": 166}], "nodes": [{"id": "T", "x": 97, "y": 24, "w": 120, "h": 46, "title": "작업(Task)"}, {"id": "S1", "x": 97, "y": 187, "w": 120, "h": 62, "title": ["1단계: 스캐폴드 제안", "(작업에 조건부)"]}, {"id": "S2", "x": 133, "y": 341, "w": 120, "h": 62, "title": ["2단계: 풀이 롤아웃", "(스캐폴드에 조건부)"]}, {"id": "R", "x": 92, "y": 534, "w": 120, "h": 46, "title": "보상(reward)"}], "edges": [{"src": "T", "dst": "S1", "kind": "data", "line": [157, 70, 157, 187]}, {"src": "S1", "dst": "S2", "kind": "data", "curve": [[187, 249], [231, 295], [231, 295], [208, 341]]}, {"src": "S2", "dst": "R", "kind": "data", "curve": [[210, 403], [231, 442], [231, 488], [179, 534]]}, {"src": "R", "dst": "S1", "kind": "event", "label": "스캐폴드로 전파", "curve": [[125, 534], [70, 442], [70, 295], [122, 249]], "off": "50%"}, {"src": "R", "dst": "S2", "kind": "event", "label": "정책으로 전파", "curve": [[152, 534], [152, 488], [152, 442], [175, 403]], "off": "50%"}, {"src": "S1", "dst": "S2", "kind": "event", "label": "공진화", "curve": [[157, 249], [157, 295], [157, 295], [178, 341]], "off": "50%"}]});
    const ensureD3 = (cb) => {
