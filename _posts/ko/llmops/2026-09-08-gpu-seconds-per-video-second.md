...
마지막으로 라이선스입니다. 후보 모델 가운데 하나는 사내 자체 호스팅이 라이선스 검토 대상입니다. 또 다른 후보는 가중치 자체가 사내 저장소에 아직 없습니다. 저희는 이런 모델을 정식 라이선스 확보 전에 프로덕션 경로에 올리지 않습니다. 그 판정은 사람의 기억이 아니라 배포 게이트 코드가 막습니다.
