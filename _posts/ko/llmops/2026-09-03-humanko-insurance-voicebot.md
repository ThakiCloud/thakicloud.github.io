---
title: "약관 452개 조항을 아는 상담원을 만들었습니다. 학습은 하지 않았습니다"
excerpt: "지난주 공개한 한국어 27B 위에 금융감독원 표준약관을 붙여, 질문에서 첫 소리까지 0.6초대에 한 문장으로 답하는 보험 상담원을 만들었습니다. 약관은 검색이 대고 말투는 가중치가 소유합니다. 데모 영상과 실측을 함께 공개합니다."
seo_title: "보험 약관 상담 음성봇: Human-KO 27B + 표준약관 RAG 실측"
...
보험 콜센터에 음성봇을 놓으려는 분이라면 두 가지가 동시에 필요하다는 걸 아실 겁니다. 답이 짧아야 하고, 그 답의 근거를 댈 수 있어야 합니다. 저희는 지난주 공개한 한국어 27B 위에 금융감독원 표준약관 452개 조항을 붙여, 질문에서 첫 소리가 날 때까지 0.6초대에 한 문장으로 답하는 상담원을 만들었습니다. 모델은 새로 학습하지 않았습니다.
...
상위 다섯 개까지 넓혀 봐도 순서는 같습니다. 본문 검색이 0.571, 상품 필터를 더해 0.714, 조항 선택은 1.000입니다.
...
합성이 매번 같지 않습니다. 같은 문장을 다섯 번 만들면 문두에서 무너지는 경우가 있고, 특정 단어로 시작할 때 그 비율이 높았습니다. 데모에 쓸 문장은 그래서 미리 여러 번 돌려 걸러냈습니다.
