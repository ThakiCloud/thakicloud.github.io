...
![거대한 적층 구조물과 작은 조명을 대비시킨 추상 이미지](/assets/images/kimi-k3-local-serving-hero.png)
...
![Kimi K3 가중치 용량과 GPU 요구량 측정 결과](/assets/images/kimi-k3-local-serving-results.png)
...
![K2.7-Code와 K3의 가중치 파일 수와 합계 용량, 인프라 한계를 비교한 슬라이드](/assets/images/kimi-k3-local-serving-slide-05.png)
...
![미러링과 재양자화가 서로 다른 공정임을 단계별로 보여 주는 슬라이드](/assets/images/kimi-k3-local-serving-slide-07.png)
...
![896개 전문가 중 16개만 계산에 쓰이지만 전체 가중치는 상주해야 함을 보여 주는 슬라이드](/assets/images/kimi-k3-local-serving-slide-03.png)
