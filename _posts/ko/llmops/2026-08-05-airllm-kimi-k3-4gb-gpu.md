...
![거대한 레이어 더미 아래에서 좁은 프레임을 통과하는 단 하나의 밝은 판을 형상화한 추상 이미지](/assets/images/airllm-kimi-k3-4gb-gpu-hero.webp)
...
![1.56TB 전체 모델 더미와 그 아래 4GB VRAM 프레임을 통과하는 단일 레이어를 그린 도식](/assets/images/airllm-kimi-k3-4gb-gpu-slide-03.webp)
...
![토큰당 1.56TB 스캔이 292초에 걸쳐 초당 5.3GB 읽기로 환산되며 NVMe 순차 읽기 한계에 맞닿는다는 도식](/assets/images/airllm-kimi-k3-4gb-gpu-slide-05.webp)
...
![실행 가능성 검증 경로와 정식 서비스 운영 경로의 GPU 요구량과 처리량이 약 500배 차이 난다는 비교 도식](/assets/images/airllm-kimi-k3-4gb-gpu-slide-06.webp)
...
![도입 검토는 예산 없이, 용량 산정은 실전 기준으로, 콜드 스타트는 디스크 병목부터라는 세 가지 지침 요약](/assets/images/airllm-kimi-k3-4gb-gpu-slide-08.webp)
