...
![대규모 연산 격자가 작은 발광 블록으로 압축되어 서버랙에 들어가는 추상 이미지](/assets/images/glm-5.2-nvfp4-vllm-hero.webp)
...
![과거 멀티 노드 종속성에서 현재 단일 8 GPU 노드 압축으로 전환된 469B 서빙 구도](/assets/images/glm-5.2-nvfp4-vllm-serving-slide-02.webp)
...
![KV 캐시 FP8·공유전문가 FP8/BF16·MoE 전문가 NVFP4로 나뉜 혼합 정밀도 계층 구조](/assets/images/glm-5.2-nvfp4-vllm-serving-slide-03.webp)
...
![양자화 자동 감지·전문가 병렬·FP8 KV 캐시 세 가지 서빙 플래그 요약](/assets/images/glm-5.2-nvfp4-vllm-serving-slide-04.webp)
...
![GLM-5.2 정밀도별 가중치 풋프린트와 단일 노드 VRAM 적재 계산](/assets/images/glm-5.2-nvfp4-vllm-results.webp)
...
![단순화된 스케줄링·소버린 AI·멀티테넌트 처리량·운영 표준화 네 가지 적용 가치](/assets/images/glm-5.2-nvfp4-vllm-serving-slide-06.webp)
...
![하드웨어 종속성·실측 벤치마크 부재·정확도 회귀 가능성 세 가지 한계 정리](/assets/images/glm-5.2-nvfp4-vllm-serving-slide-07.webp)
