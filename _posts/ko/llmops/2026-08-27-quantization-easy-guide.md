...
toc_sticky: true
reading_time: true
audiobook: "https://drive.google.com/file/d/1cXhO3lF0JzatKFK-FdY7XIsFnkOKTEJY/view"
...
<!-- nlm-visual -->
![비트폭과 블록 스케일링, 하드웨어별 커널 경로를 한 장으로 요약한 인포그래픽](/assets/images/posts/news/quantization-easy-guide/nlm-infographic-1.webp)
*이 글의 뼈대를 한 장으로 본 그림입니다. NotebookLM이 본문을 소스로 생성했습니다.*
...
<!-- nlm-visual -->
![포맷 선택 기준과 품질 손실 구간을 정리한 인포그래픽](/assets/images/posts/news/quantization-easy-guide/nlm-infographic-2.webp)
*고르는 기준을 다시 한 장으로 모으면 이렇습니다. NotebookLM이 본문을 소스로 생성했습니다.*
