...
![눈금이 16칸뿐인 자로 재봅니다: 양자화 쉽게 읽기 개념을 형상화한 이미지](/assets/images/quantization-easy-guide-hero.webp)
*글의 핵심 개념을 형상화했습니다.*
...
<!-- nlm-visual -->
![핵심 개념 요약 인포그래픽 1](/assets/images/posts/news/quantization-easy-guide/nlm-infographic-1.webp)
...
<!-- nlm-visual -->
![핵심 개념 요약 인포그래픽 2](/assets/images/posts/news/quantization-easy-guide/nlm-infographic-2.webp)
*NotebookLM이 소스를 종합해 생성한 인포그래픽입니다.*
