...
author_profile: true
toc: false
image: /assets/images/posts/만화/prompt-gallery-hidden-retries/strip.png
...
![프롬프트는 공개, 재시도 47번은 비공개](/assets/images/posts/만화/prompt-gallery-hidden-retries/strip.png)
...
<video controls playsinline preload="metadata" poster="/assets/images/posts/만화/prompt-gallery-hidden-retries/strip.png" style="width:100%;border-radius:8px;">
