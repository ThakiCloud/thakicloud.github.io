...
author_profile: true
toc: false
image: /assets/images/posts/만화/cheap-model-checked-itself-eleven-times/strip.png
...
![싼 놈이 열한 번 세서 이겼다](/assets/images/posts/만화/cheap-model-checked-itself-eleven-times/strip.png)
...
<video controls playsinline preload="metadata" poster="/assets/images/posts/만화/cheap-model-checked-itself-eleven-times/strip.png" style="width:100%;border-radius:8px;">
