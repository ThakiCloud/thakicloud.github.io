...
![클라우드 헤드리스 서버의 스마트폰 화면이 빛의 입자로 흩어져 네트워크를 타고 브라우저 창으로 흘러 들어가는 추상 이미지](/assets/images/serve-sim-ios-simulator-web-hero.png)
...
![serve-sim-ios-simulator-web 슬라이드 1](/assets/images/serve-sim-ios-simulator-web-slide-01.png)

![serve-sim-ios-simulator-web 슬라이드 2](/assets/images/serve-sim-ios-simulator-web-slide-02.png)

![serve-sim-ios-simulator-web 슬라이드 3](/assets/images/serve-sim-ios-simulator-web-slide-03.png)

![serve-sim-ios-simulator-web 슬라이드 4](/assets/images/serve-sim-ios-simulator-web-slide-04.png)
