...
toc_icon: "cog"
toc_sticky: true
canonical_url: "https://thakicloud.com/tech-blog/owm/kyutai-tts-streaming-voice-synthesis-guide/"
reading_time: true
published: false
categories:
  - owm
...
-->
<div class="d3-arch" data-arch-root id="amingvoicesynthesisguide-1"></div>
<style>
...
<script>
  (() => {
    const SPEC = ({"title": "", "ariaLabel": "", "width": 351, "height": 618, "legendTitle": "Legend", "hint": "Hover a node to trace its connections.", "groups": [], "nodes": [{"id": "A", "x": 112, "y": 24, "w": 120, "h": 46, "title": "텍스트 입력"}, {"id": "B", "x": 103, "y": 148, "w": 138, "h": 52, "title": "처리 방식"}, {"id": "C", "x": 199, "y": 292, "w": 120, "h": 46, "title": "전체 텍스트 대기"}, {"id": "D", "x": 24, "y": 292, "w": 120, "h": 46, "title": "실시간 스트리밍"}, {"id": "E", "x": 199, "y": 416, "w": 120, "h": 46, "title": "배치 처리"}, {"id": "F", "x": 24, "y": 416, "w": 120, "h": 46, "title": "점진적 음성 출력"}, {"id": "G", "x": 199, "y": 540, "w": 120, "h": 46, "title": "최종 음성 파일"}, {"id": "H", "x": 24, "y": 540, "w": 120, "h": 46, "title": "실시간 재생"}], "edges": [{"src": "A", "dst": "B", "kind": "data", "line": [172, 70, 172, 148]}, {"src": "B", "dst": "C", "kind": "data", "label": "기존 TTS", "curve": [[203, 200], [259, 246], [259, 246], [259, 292]], "off": "50%"}, {"src": "B", "dst": "D", "kind": "data", "label": "Kyutai TTS", "curve": [[140, 200], [84, 246], [84, 246], [84, 292]], "off": "50%"}, {"src": "C", "dst": "E", "kind": "data", "line": [259, 338, 259, 416]}, {"src": "D", "dst": "F", "kind": "data", "line": [84, 338, 84, 416]}, {"src": "E", "dst": "G", "kind": "data", "line": [259, 462, 259, 540]}, {"src": "F", "dst": "H", "kind": "data", "line": [84, 462, 84, 540]}]});
    const ensureD3 = (cb) => {
    ...
    const bootstrap = () => {
      const container = document.getElementById('amingvoicesynthesisguide-1')
        || document.querySelector('.d3-arch[data-arch-root]:not([data-mounted])');
      if (!container || (container.dataset && container.dataset.mounted === 'true')) return;
      if (container.dataset) container.dataset.mounted = 'true';

      try {
        const uid = 'amingvoicesynthesisguide-1';
