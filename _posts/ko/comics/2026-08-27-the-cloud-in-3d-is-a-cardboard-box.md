---
title: "클라우드를 3D로 만들었더니 종이상자였다"
excerpt: "사진 한 장이 돌아다니는 3D 세상이 됐네. 클라우드도 3D로 만들었더니, 돌고 있는 종이상이더라."
date: 2026-08-27
categories:
  - comics
tags:
...
ThakiCloud는 이 논리를 회사 규모로 돌립니다. Paxis가 에이전트 오케스트레이션을 맡고 Metis가 학습과 추론을 맡습니다. 모델·데이터·GPU까지 전부 내 시설 안에 있어요. 클라우드가 종이상이었다는 건 만화의 웃긴 부분이고 그 상자를 열어서 안을 볼 수 있다는 게 진짜입니다. 온프렘이면 청구서를 읽는 게 누군가의 화면이 아니라 내 미터의 숫자라는 뜻이에요. 내가 만든 3D 세계는 돌리는 기계까지 전부 내 손에 있습니다.
