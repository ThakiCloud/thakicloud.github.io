---
title: "직권조사가 대문에 멈췄다"
excerpt: "신고 안 해도 털리면 정부가 바로 뒤집는 시대. 우리의 직권 조사 결과: 없었어요. 데이터가 이 성을 안 나왔거든요."
date: 2026-09-08
categories:
  - comics
tags:
...
![직권조사가 대문에 멈췄다](/assets/images/posts/만화/ex-officio-inquiry-stopped-at-the-gate/strip.webp)
...
<video controls playsinline preload="metadata" poster="/assets/images/posts/만화/ex-officio-inquiry-stopped-at-the-gate/strip.webp" style="width:100%;border-radius:8px;">
  ...
  <track kind="subtitles" srclang="ko" label="한국어" src="/assets/videos/posts/만화/ex-officio-inquiry-stopped-at-the-gate/comic.ko.vtt" default>
</video>

[영상 다운로드](/assets/videos/posts/만화/ex-officio-inquiry-stopped-at-the-gate/comic.mp4)

## ThakiCloud 제품 적용 시사점

직권조사 제도가 드러낸 건, '데이터가 어디 있느냐'가 조사 자체의 출발점이 됐다는 겁니다. ThakiCloud의 답은 주권형 온프렘이에요. 모델도 데이터도 인프라도 전부 고객 시설 안에서 돌기 때문에 데이터는 대문을 안 나갑니다. 그러면 직권이든 무엇이든 조사관이 먼저 확인할 수 있는 게 임대인의 데이터센터가 아니라 고객 자기 쪽에 있는 것이지요. 파시스는 만화처럼 대문과 경계에 보안 검증 에이전트를 세우고, 메티스는 학습과 추론을 고객 GPU에서 실행합니다. 조사를 막으려 해서가 아닙니다. 데이터가 대문을 안 통과할 뿐이에요.
