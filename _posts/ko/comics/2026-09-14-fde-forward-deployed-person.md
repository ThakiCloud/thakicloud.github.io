---
title: "FDE 상주, 전진 배치된 건 사람뿐"
excerpt: "빅테크가 고객사에 엔지니어 상주(FDE)를 시작했는데, 전진 배치된 건 사람뿐. 스택은 여전히 남의 구름을 왕복 중."
date: 2026-09-14
categories:
  - comics
tags:
...
[영상 다운로드](/assets/videos/posts/만화/fde-forward-deployed-person/comic.mp4)

## ThakiCloud 제품 적용 시사점

만화에 나온 '우리형 FDE'는 파시스가 실제로 풀고 있는 에이전트입니다. 엔지니어 한 명이 출장 대신 에이전트가 현장에 붙으면, 들이는 돈은 전력·네트워크 비용뿐이라 상주비가 아니라 전기요금으로 청구서가 바뀌어요. 여기에 메티스까지 같은 건물 안에 싣으면 구도가 달라집니다. 모델, 데이터, 추론, 그리고 청구서까지 전부 자기 울타리 안에서 도는 것. 그게 온프렘이고, ThakiCloud가 말하는 주권입니다. 사람만 상주시키는 이 시대에, 우리는 스택을 전진 배치했습니다.
