...
![서로 다른 색의 입자 흐름이 중심의 빛나는 결정 구조로 수렴하는 추상 이미지]({{ '/assets/images/platonic-representation-hypothesis-hero.webp' | relative_url }})
...
![기존 직관(발산)과 플라토닉 가설(수렴)의 대비]({{ '/assets/images/platonic-representation-hypothesis-slide-04.webp' | relative_url }})
...
![상호 최근접 이웃 정렬, 78개 비전 모델, 모달리티 교차라는 수렴의 정량적 증거]({{ '/assets/images/platonic-representation-hypothesis-slide-05.webp' | relative_url }})
...
![점별 상호정보량으로 수렴하는 현실의 통계 모델]({{ '/assets/images/platonic-representation-hypothesis-slide-07.webp' | relative_url }})
...
![임베딩 격리 완화, 경량 정렬 계층, 저비용 진단 신호라는 플랫폼 적용 시사점]({{ '/assets/images/platonic-representation-hypothesis-slide-08.webp' | relative_url }})
...
![사회학적 동형화, 환원 불가능한 모달리티 차이, 측정 지표 해석 의존성이라는 한계]({{ '/assets/images/platonic-representation-hypothesis-slide-09.webp' | relative_url }})
