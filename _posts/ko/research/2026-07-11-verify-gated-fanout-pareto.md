...
![적은 검증이 더 안전하다: 멀티에이전트 검증 게이트의 비용-품질 곡선을 실측하다 개념을 형상화한 이미지](/assets/images/verify-gated-fanout-pareto-hero.png)
*글의 핵심 개념을 형상화했습니다.*
...
![Cost vs. Hallucination Survival Rate by Tier and Breadth]({{ '/assets/images/posts/research/verify-gated-fanout-pareto/fig_pareto_cost_quality.png' | relative_url }})
...
![Cost vs. True-Finding Survival Rate by Tier]({{ '/assets/images/posts/research/verify-gated-fanout-pareto/fig_cost_true_survival.png' | relative_url }})
...
![Non-Monotonicity: Adding More Skeptics Can Harm Verification Safety]({{ '/assets/images/posts/research/verify-gated-fanout-pareto/fig_nonmonotonicity.png' | relative_url }})
...
![verify-gated-fanout-pareto 슬라이드 1]({{ '/assets/images/verify-gated-fanout-pareto-slide-01.png' | relative_url }})

![verify-gated-fanout-pareto 슬라이드 2]({{ '/assets/images/verify-gated-fanout-pareto-slide-02.png' | relative_url }})

![verify-gated-fanout-pareto 슬라이드 3]({{ '/assets/images/verify-gated-fanout-pareto-slide-03.png' | relative_url }})

![verify-gated-fanout-pareto 슬라이드 4]({{ '/assets/images/verify-gated-fanout-pareto-slide-04.png' | relative_url }})
