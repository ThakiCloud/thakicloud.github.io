...
![계열별 sd(예측)/sd(실험) 분포. Boltz-2는 1.0 왼쪽에, FEP+는 오른쪽에 모입니다](/assets/images/boltz2-fep-shrinkage.png)
...
![계열별 오차 차이. 좌우로 갈리고 한쪽으로 쏠리지 않습니다](/assets/images/boltz2-fep-contamination.png)
