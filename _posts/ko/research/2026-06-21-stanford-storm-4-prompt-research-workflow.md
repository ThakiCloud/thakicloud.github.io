...
리서치는 시간이 많이 드는 일입니다. 한 주제를 제대로 파려면 질문을 세우고 여러 관점에서 자료를 모으고 구조를 잡아 인용을 단 결과물을 써야 합니다. 스탠퍼드 OVAL 연구실이 발표한 STORM(Synthesis of Topic Outlines through Retrieval and Multi-perspective question asking)은 이 과정을 LLM으로 자동화하는 지식 큐레이션 시스템입니다. NAACL 2024에서 발표되었으며 위키피디아 수준의 긴 글을 인용과 함께 처음부터 생성하는 것을 목표로 합니다.
...
STORM의 메시지는 분명합니다. 좋은 리서치 자동화는 "더 똑똑한 모델"이 아니라 "더 좋은 작성 전 단계 설계"에서 나옵니다. 작성하기 전에 질문하고 조사하며 구조를 잡으십시오. 그 다음에 쓰십시오.
