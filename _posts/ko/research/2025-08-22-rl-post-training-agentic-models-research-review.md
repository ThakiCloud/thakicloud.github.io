...
toc_icon: "cog"
toc_sticky: true
canonical_url: "https://thakicloud.com/tech-blog/ko/research/rl-post-training-agentic-models-research-review/"
reading_time: true
published: false
categories:
  - research
...
**논문**: Visual-ARFT: Visual Agentic Reinforcement Fine-Tuning (arXiv 2505.14246, 2025년 5월)
...
**논문**: ReTool: Reinforcement Learning for Strategic Tool Use in LLMs (arXiv 2504.11536, 2025년 4월)
...
**논문**: UFT: Unifying Supervised and Reinforcement Fine-Tuning (arXiv 2505.16984, 2025년 5월)
...
본 리뷰에서 다룬 논문들의 arXiv 원문은 다음과 같습니다. 각 링크는 작성 시점에 arXiv 초록 페이지에서 제목을 직접 확인한 것입니다.
