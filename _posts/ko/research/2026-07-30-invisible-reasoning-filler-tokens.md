...
![반투명 유리 판 내부로 빛의 띠가 지나가지만 바깥 표면에는 아무 흔적도 남지 않는 추상 이미지](/assets/images/invisible-reasoning-filler-tokens-hero.png)
...
![성능 향상, 토큰 의존성, 모델별 선호도라는 세 가지 진단 기준을 정리한 슬라이드](/assets/images/invisible-reasoning-filler-tokens-slide-03.png)
...
![논문 Table 1의 13개 모델별 필러 토큰 정확도 변화량을 산술과 곱셈 과제로 나눠 그린 막대 차트](/assets/images/invisible-reasoning-filler-tokens-results.png)
...
![숨은 목표 달성 결과와 잔차 스트림 이식 실험의 계층별 회복률을 정리한 슬라이드](/assets/images/invisible-reasoning-filler-tokens-slide-05.png)
...
![ai-platform의 인프라 통제, Paxis의 정책 게이트, 그리고 도입 한계점을 나란히 정리한 슬라이드](/assets/images/invisible-reasoning-filler-tokens-slide-06.png)
