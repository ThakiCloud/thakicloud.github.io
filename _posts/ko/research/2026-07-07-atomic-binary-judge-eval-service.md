...
![규제 산업의 데이터 주권과 비용 지연 및 설명 가능성을 기준으로 기존 방식과 제안 아키텍처를 비교한 표]({{ '/assets/images/atomic-binary-judge-eval-service-slide-03.webp' | relative_url }})
...
![이진 기준 분해부터 워커 판정과 코드 집계 및 적대적 표결 검증으로 이어지는 4단계 아키텍처 흐름도]({{ '/assets/images/atomic-binary-judge-eval-service-slide-04.webp' | relative_url }})
