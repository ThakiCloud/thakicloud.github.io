...
-->
<div class="d3-arch" data-arch-root id="optimizationllmframework-1"></div>
<style>
...
<script>
  (() => {
    const SPEC = ({"title": "", "ariaLabel": "", "width": 446, "height": 776, "legendTitle": "Legend", "hint": "Hover a node to trace its connections.", "groups": [], "nodes": [{"id": "X", "x": 97, "y": 24, "w": 191, "h": 62, "title": ["입력 x = 알려진부분 x_k + 미지부분", "x_u"]}, {"id": "FP", "x": 132, "y": 164, "w": 120, "h": 62, "title": ["프라이멀 작업", "입력으로 출력 y 생성"]}, {"id": "Y", "x": 294, "y": 304, "w": 120, "h": 46, "title": "출력 y"}, {"id": "XK", "x": 119, "y": 304, "w": 120, "h": 46, "title": "알려진 부분 x_k"}, {"id": "FD", "x": 188, "y": 428, "w": 156, "h": 62, "title": ["듀얼 작업", "y 와 x_k 로 미지부분 재구성"]}, {"id": "XU", "x": 206, "y": 568, "w": 120, "h": 46, "title": "재구성된 x_u_hat"}, {"id": "R", "x": 116, "y": 692, "w": 153, "h": 52, "title": "원본 x_u 와 유사도 측정"}], "edges": [{"src": "X", "dst": "FP", "kind": "data", "line": [192, 86, 192, 164]}, {"src": "FP", "dst": "Y", "kind": "data", "curve": [[252, 221], [354, 265], [354, 265], [354, 304]]}, {"src": "XK", "dst": "FD", "kind": "data", "curve": [[179, 350], [179, 389], [179, 389], [227, 428]]}, {"src": "Y", "dst": "FD", "kind": "data", "curve": [[354, 350], [354, 389], [354, 389], [305, 428]]}, {"src": "FD", "dst": "XU", "kind": "data", "line": [266, 490, 266, 568]}, {"src": "XU", "dst": "R", "kind": "data", "curve": [[266, 614], [266, 653], [266, 653], [222, 692]]}, {"src": "R", "dst": "FP", "kind": "data", "label": "\"자기 감독 보상\"", "curve": [[138, 692], [56, 529], [56, 327], [132, 226]], "off": "50%"}]});
    const ensureD3 = (cb) => {
    ...
    const bootstrap = () => {
      const container = document.getElementById('optimizationllmframework-1')
        || document.querySelector('.d3-arch[data-arch-root]:not([data-mounted])');
      if (!container || (container.dataset && container.dataset.mounted === 'true')) return;
      if (container.dataset) container.dataset.mounted = 'true';

      try {
        const uid = 'optimizationllmframework-1';
