...
![서로를 재구성하며 대칭을 이루는 프라이멀-듀얼 흐름을 형상화한 추상 이미지](/assets/images/dupo-dual-policy-optimization-llm-framework-hero.png)
...
```mermaid
flowchart LR
    X["입력 x = 알려진부분 x_k + 미지부분 x_u"] --> FP["프라이멀 작업<br/>입력으로 출력 y 생성"]
    FP --> Y["출력 y"]
    XK["알려진 부분 x_k"] --> FD["듀얼 작업<br/>y 와 x_k 로 미지부분 재구성"]
    Y --> FD
    FD --> XU["재구성된 x_u_hat"]
    XU --> R{"원본 x_u 와 유사도 측정"}
    R -->|"자기 감독 보상"| FP
```
...
![dupo-dual-policy-optimization-llm-framework 슬라이드 1](/assets/images/dupo-dual-policy-optimization-llm-framework-slide-01.png)

![dupo-dual-policy-optimization-llm-framework 슬라이드 2](/assets/images/dupo-dual-policy-optimization-llm-framework-slide-02.png)

![dupo-dual-policy-optimization-llm-framework 슬라이드 3](/assets/images/dupo-dual-policy-optimization-llm-framework-slide-03.png)

![dupo-dual-policy-optimization-llm-framework 슬라이드 4](/assets/images/dupo-dual-policy-optimization-llm-framework-slide-04.png)
