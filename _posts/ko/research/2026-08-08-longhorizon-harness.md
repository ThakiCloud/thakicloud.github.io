...
![여러 노드가 이어진 실행 사슬 위에 떠 있는 반투명 상태 레코드를 표현한 추상 이미지](/assets/images/longhorizon-harness-hero.webp)
...
![논문이 보고한 벤치마크 델타와 로컬에서 실측한 설치 풋프린트](/assets/images/longhorizon-harness-results.webp)
...
![매니저와 실행자 사이의 컨텍스트 단절, 실행자와 감사자 사이의 자기 보고 차단을 보여주는 도식](/assets/images/longhorizon-harness-slide-04.webp)
...
![프롬프트 지시, 하드코딩된 도구 권한, 사후 탐지로 이어지는 감사자 읽기 전용 3중 방어선](/assets/images/longhorizon-harness-slide-07.webp)
...
![매니저는 최고 지능 모델, 감사자는 분석 특화 모델, 실행자는 비용 효율 모델로 배분하는 역할별 라우팅 도식](/assets/images/longhorizon-harness-slide-09.webp)
...
![벤치마크 절대 수치의 한계, 단기 태스크 오버헤드, 유용한 컨텍스트 손실 위험을 정리한 도식](/assets/images/longhorizon-harness-slide-11.webp)
