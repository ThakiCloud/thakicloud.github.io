...
![BM25 어휘 점수와 임베딩 유사도를 가중치 w와 임계값 타우로 조절해 상호 순위 융합으로 합치는 하이브리드 라우팅 다이어그램](/assets/images/bandit-hybrid-retrieval-calibration-slide-03.webp)
...
![스킬 이름 변경과 폐기 및 통합으로 인해 고정된 검색 가중치와 임계값이 무력화되는 라이브러리 드리프트 다이어그램](/assets/images/bandit-hybrid-retrieval-calibration-slide-04.webp)
