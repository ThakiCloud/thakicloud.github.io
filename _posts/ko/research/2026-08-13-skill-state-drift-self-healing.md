...
![세션 시작 체크와 주기적 스윕의 평균·P95 탐지 지연 비교](/assets/images/posts/research/skill-state-drift-self-healing/fig-latency-comparison.png)
...
![체크 간격 분산이 지연 격차를 만드는 renewal theory 계산](/assets/images/posts/research/skill-state-drift-self-healing/fig-inspection-paradox.png)
...
![체크 이벤트 수와 셀 스캔 수를 나눠서 본 오버헤드 비교](/assets/images/posts/research/skill-state-drift-self-healing/fig-overhead.png)
