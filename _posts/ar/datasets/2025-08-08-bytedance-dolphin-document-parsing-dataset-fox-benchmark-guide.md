...
![نظرة عامة على خط معالجة Analyze-then-Parse في ByteDance Dolphin]({{ '/assets/images/bytedance-dolphin-document-parsing-dataset-fox-benchmark-guide-hero.webp' | relative_url }})
