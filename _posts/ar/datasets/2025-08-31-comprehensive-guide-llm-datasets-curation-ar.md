...
![رسم تخطيطي: بيانات من مصادر متعددة تمر عبر طبقات التصفية وتتجمّع في نواة بيانات تدريب مُنقّحة واحدة]({{ '/assets/images/comprehensive-guide-llm-datasets-curation-hero.webp' | relative_url }})
...
![رسم تخطيطي لمسار تنسيق بيانات التدريب اللاحق للنماذج اللغوية: من الجمع إلى محاذاة التفضيلات والتحقق]({{ '/assets/images/comprehensive-guide-llm-datasets-curation-diagram.svg' | relative_url }})
...
- [mlabonne/llm-datasets - قائمة منسّقة بمجموعات البيانات وأدوات التدريب اللاحق (GitHub)](https://github.com/mlabonne/llm-datasets)
- [Distilabel - إطار البيانات الاصطناعية وتغذية الذكاء الاصطناعي الراجعة](https://github.com/argilla-io/distilabel)
- [Argilla - منصة تعاون وتوسيم مجموعات البيانات](https://github.com/argilla-io/argilla)
- [Trafilatura - استخراج النص والبيانات الوصفية من الويب](https://github.com/adbar/trafilatura)
