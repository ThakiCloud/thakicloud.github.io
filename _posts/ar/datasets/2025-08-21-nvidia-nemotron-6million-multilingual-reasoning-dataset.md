...
```mermaid
flowchart TD
    A[بيانات الاستدلال الإنجليزية<br/>الطلب · الاستجابة · سلسلة الاستدلال] --> B{تقسيم أهداف الترجمة}
    B -->|الطلب · الاستجابة| C[الترجمة إلى 5 لغات<br/>fr · es · de · it · ja]
    B -->|سلسلة الاستدلال| D[الإبقاء على الأصل الإنجليزي]
    C --> E[نماذج الترجمة<br/>الألمانية Qwen2.5-32B-Instruct-AWQ<br/>اللغات الأربع الأخرى Qwen2.5-14B-Instruct]
    E --> F[ضبط الجودة 1<br/>ترجمة سطرًا بسطر · تخطي كتل الأكواد]
    F --> G[ضبط الجودة 2<br/>فرض تنسيق الأقواس · استبعاد تلقائي للمخالف]
    G --> H[ضبط الجودة 3<br/>تحديد اللغة عبر fastText<br/>55,567 مثال · استبعاد 1.1%]
    D --> I[مجموعة بيانات استدلال متعددة اللغات بـ 6 ملايين<br/>nvidia-open-model-license]
    H --> I
```
