...
canonical_url: "https://thakicloud.com/tech-blog/ar/llmops/raghub-comprehensive-guide-to-rag-ecosystem-ar/"
categories:
  - llmops
published: false
---
...
![رسم تخطيطي: كتل أطر عمل معيارية متصلة حول فهرس متجهات مركزي في النظام البيئي لـ RAG]({{ '/assets/images/raghub-comprehensive-guide-to-rag-ecosystem-hero.webp' | relative_url }})
...
![رسم يربط فئات أطر عمل RAGHub (الأساسية، المحركات، تجهيز البيانات، التقييم) بمراحل مسار RAG]({{ '/assets/images/raghub-comprehensive-guide-to-rag-ecosystem-diagram.svg' | relative_url }})
...
- [Andrew-Jang/RAGHub - دليل RAG مجتمعي (GitHub, MIT)](https://github.com/Andrew-Jang/RAGHub)
...
- [مجتمع r/RAG](https://www.reddit.com/r/Rag/)
