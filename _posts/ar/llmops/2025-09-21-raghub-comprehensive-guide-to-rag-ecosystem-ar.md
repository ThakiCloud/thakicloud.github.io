...
![رسم تخطيطي: كتل أطر عمل معيارية متصلة حول فهرس متجهات مركزي في النظام البيئي لـ RAG](/assets/images/raghub-comprehensive-guide-to-rag-ecosystem-hero.webp)
...
![رسم يربط فئات أطر عمل RAGHub (الأساسية، المحركات، تجهيز البيانات، التقييم) بمراحل مسار RAG](/assets/images/raghub-comprehensive-guide-to-rag-ecosystem-diagram.svg)
