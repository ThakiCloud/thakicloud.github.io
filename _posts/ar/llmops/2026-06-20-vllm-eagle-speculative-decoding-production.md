...
<script>
  (() => {
    const SPEC = ({"title": "", "ariaLabel": "", "width": 423, "height": 572, "legendTitle": "Legend", "hint": "Hover a node to trace its connections.", "groups": [], "nodes": [{"id": "D", "x": 126, "y": 24, "w": 170, "h": 62, "title": ["نموذج المسودة", "نحو 1/10 من المستهدف"]}, {"id": "V", "x": 191, "y": 178, "w": 170, "h": 78, "title": ["تحقق متوازٍ بالنموذج", "المستهدف", "مرور أمامي واحد"]}, {"id": "A", "x": 196, "y": 334, "w": 160, "h": 52, "title": "هل تُقبل الرموز؟"}, {"id": "O", "x": 242, "y": 486, "w": 149, "h": 46, "title": "تُدمج في المخرجات"}, {"id": "R", "x": 24, "y": 478, "w": 163, "h": 62, "title": ["إعادة البدء من نقطة", "التباين"]}], "edges": [{"src": "D", "dst": "V", "kind": "data", "label": "\"توليد k رموز\"", "curve": [[237, 86], [276, 132], [276, 132], [276, 178]], "off": "50%"}, {"src": "V", "dst": "A", "kind": "data", "line": [276, 256, 276, 334]}, {"src": "A", "dst": "O", "kind": "data", "label": "\"مقبولة\"", "curve": [[291, 386], [317, 432], [317, 432], [317, 486]], "off": "50%"}, {"src": "A", "dst": "R", "kind": "data", "label": "\"أول تباين\"", "curve": [[238, 386], [171, 432], [171, 432], [132, 478]], "off": "50%"}, {"src": "R", "dst": "D", "kind": "data", "curve": [[94, 478], [78, 360], [78, 217], [157, 86]]}]});
    const ensureD3 = (cb) => {
