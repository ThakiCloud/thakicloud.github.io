...
![مخطط لاستراتيجية التكميم الانتقائي ومسار الخدمة في GLM-5.2-NVFP4]({{ '/assets/images/nvidia-glm-5-2-nvfp4-diagram.webp' | relative_url }})
...
![رسم بياني شريطي يقارن خط أساس FP8 ودرجات معايير NVFP4]({{ '/assets/images/nvidia-glm-5-2-nvfp4-results.webp' | relative_url }})
