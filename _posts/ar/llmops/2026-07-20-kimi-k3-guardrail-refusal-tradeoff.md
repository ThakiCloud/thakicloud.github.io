...
![صورة تجريدية تُقابل بين تدفق ضوء يعبر نقطة تفتيش محكومة وحاجز مغلق]({{ '/assets/images/kimi-k3-guardrail-refusal-tradeoff-hero.webp' | relative_url }})
...
![درجات معايير القياس التي أعلنتها Moonshot لوكيل البرمجة في Kimi K3]({{ '/assets/images/kimi-k3-guardrail-refusal-tradeoff-results.webp' | relative_url }})
