...
```mermaid
flowchart TD
    A[البيانات المصدر\nالملاحظات السريرية / السجلات الطبية الإلكترونية / رموز الوصفات] --> B[معالجة إخفاء الهوية\nETL داخلي بالمستشفى]
    B --> C[رفع مجموعة البيانات\nThakiCloud Dataset Manager\nتنسيق HuggingFace / تخزين متوافق مع S3]
    ...
    G --> H[النموذج المدرَّب\nتخزين داخلي]
    H --> I[نقطة نهاية vLLM بدون خادم دائم\nKEDA Scale-to-Zero]
    I --> J[مستهلكو واجهة البرمجة الداخلية\nنظام السجلات الطبية / دعم القرار السريري]
```
