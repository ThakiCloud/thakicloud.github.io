...
![صورة تجريدية لمئات المكعبات الزجاجية على شبكة داكنة، ثلاثة منها فقط مضاءة بضوء دافئ](/assets/images/kat-coder-v25-dev-onprem-hero.png)
...
![رسم بياني مزدوج يقارن نتائج معايير البرمجة الوكيلية وحجم ذاكرة KV لسياق 262 ألف رمز](/assets/images/kat-coder-v25-dev-onprem-results.png)
