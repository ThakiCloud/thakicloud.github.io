...
![رسم توضيحي تجريدي لمكعبات زجاجية متراصة تُضغط دون خسارة إلى كتلة أصغر]({{ '/assets/images/lossless-bf16-compression-hero.webp' | relative_url }})
...
![مخطط لقياس Qwen2.5-0.5B يظهر أن حقل الأس في BF16 يستخدم فعليا 2.64 بت فقط، وأن ضغطه بلا خسارة يقلّص GLM-5.2 من 1403 غيغابايت إلى نحو 980 غيغابايت]({{ '/assets/images/lossless-bf16-compression-results.webp' | relative_url }})
