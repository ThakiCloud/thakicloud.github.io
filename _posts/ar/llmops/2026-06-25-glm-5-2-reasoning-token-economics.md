...
toc_icon: "microchip"
toc_sticky: true
canonical_url: "https://thakicloud.com/tech-blog/ar/llmops/glm-5-2-reasoning-token-economics/"
reading_time: true
categories:
  - llmops
published: false
...
![مقارنة هيكل التكلفة بين مسار واجهة السحابة المغلقة ومسار الاستضافة الذاتية داخل المقر لدى ThakiCloud]({{ '/assets/images/glm-5-2-reasoning-token-economics-diagram.webp' | relative_url }})
...
![بصمة الذاكرة لأوزان 744B وفق الدقة، ومنحنى تكلفة الإخراج للمهمة]({{ '/assets/images/glm-5-2-reasoning-token-economics-results.webp' | relative_url }})
...
- مقال ذو صلة (التكميم): [Unsloth GLM-5.2 1بت Dynamic GGUF تحليل داخل المقر](https://thakicloud.com/tech-blog/ko/llmops/unsloth-glm-5-2-1bit-gguf/)
