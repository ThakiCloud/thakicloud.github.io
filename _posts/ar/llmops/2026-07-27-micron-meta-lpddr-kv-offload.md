...
![صورة تجريدية لنواة صغيرة مضيئة تحيط بها طبقات شفافة واسعة على خلفية داكنة](/assets/images/micron-meta-lpddr-kv-offload-hero.png)
...
![رسم أعمدة بمقياس لوغاريتمي يبيّن حجم ذاكرة KV لنموذج Llama 3 70B حسب طول السياق مع خطوط سعة طبقات الذاكرة](/assets/images/micron-meta-lpddr-kv-offload-results.png)
