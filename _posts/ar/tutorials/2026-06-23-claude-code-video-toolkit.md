...
![تمثيل تجريدي لخط إنتاج فيديو مؤتمت](/assets/images/claude-code-video-toolkit-hero.webp)
...
![مخطط الأزمنة المقاسة لكل مرحلة في خط عرض hello-world](/assets/images/claude-code-video-toolkit-results.webp)
