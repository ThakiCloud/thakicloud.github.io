...
-->
<div class="d3-arch" data-arch-root id="cloopscompletetutorialar-1"></div>
<style>
...
<script>
  (() => {
    const SPEC = ({"title": "", "ariaLabel": "", "width": 238, "height": 742, "legendTitle": "Legend", "hint": "Hover a node to trace its connections.", "groups": [], "nodes": [{"id": "A", "x": 33, "y": 24, "w": 120, "h": 46, "title": "تعريف الهدف"}, {"id": "B", "x": 29, "y": 148, "w": 128, "h": 46, "title": "اختيار الأدوات"}, {"id": "C", "x": 32, "y": 272, "w": 121, "h": 46, "title": "تنفيذ الإجراء"}, {"id": "D", "x": 85, "y": 396, "w": 121, "h": 46, "title": "تقييم النتائج"}, {"id": "E", "x": 24, "y": 520, "w": 138, "h": 52, "title": "تحقق الهدف؟"}, {"id": "F", "x": 33, "y": 664, "w": 120, "h": 46, "title": "النجاح"}], "edges": [{"src": "A", "dst": "B", "kind": "data", "line": [93, 70, 93, 148]}, {"src": "B", "dst": "C", "kind": "data", "line": [93, 194, 93, 272]}, {"src": "C", "dst": "D", "kind": "data", "curve": [[112, 318], [145, 357], [145, 357], [145, 396]]}, {"src": "D", "dst": "E", "kind": "data", "curve": [[145, 442], [145, 481], [145, 481], [114, 520]]}, {"src": "E", "dst": "C", "kind": "data", "label": "لا", "curve": [[72, 520], [41, 481], [41, 357], [74, 318]], "off": "50%"}, {"src": "E", "dst": "F", "kind": "data", "label": "نعم", "line": [93, 572, 93, 664], "lx": 93, "ly": 614}]});
    const ensureD3 = (cb) => {
    ...
    const bootstrap = () => {
      const container = document.getElementById('cloopscompletetutorialar-1')
        || document.querySelector('.d3-arch[data-arch-root]:not([data-mounted])');
      if (!container || (container.dataset && container.dataset.mounted === 'true')) return;
      if (container.dataset) container.dataset.mounted = 'true';

      try {
        const uid = 'cloopscompletetutorialar-1';
