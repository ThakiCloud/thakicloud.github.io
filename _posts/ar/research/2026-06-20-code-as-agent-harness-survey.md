...
يلخص الرسم التالي كيف يعمل الكود كتجهيز بين محرك الاستدلال والبيئة، مع بناء طبقتي الآلية والتنسيق فوقه.
...
<script>
  (() => {
    const SPEC = ({"title": "", "ariaLabel": "", "width": 583, "height": 692, "legendTitle": "Legend", "hint": "Hover a node to trace its connections.", "groups": [{"x": 253, "y": 162, "w": 298, "h": 498, "label": "الكود كتجهيز للعامل", "lx": 265, "ly": 180}], "nodes": [{"id": "LLM", "x": 308, "y": 24, "w": 156, "h": 46, "title": "محرك الاستدلال LLM"}, {"id": "L1", "x": 290, "y": 201, "w": 191, "h": 78, "title": ["الطبقة 1 واجهة التجهيز", "تعريف ثنائي الاتجاه بين", "النموذج والبيئة"]}, {"id": "L2", "x": 322, "y": 379, "w": 191, "h": 62, "title": ["الطبقة 2 آلية التجهيز", "التخطيط والتحكم التكيفي"]}, {"id": "L3", "x": 322, "y": 527, "w": 191, "h": 94, "title": ["الطبقة 3 تنسيق العملاء", "المتعددين", "التوزيع والتجميع وإدارة", "التبعيات"]}, {"id": "ENV", "x": 24, "y": 371, "w": 191, "h": 78, "title": ["البيئة", "نظام الملفات وواجهات", "البرمجة وقواعد البيانات"]}], "edges": [{"src": "LLM", "dst": "L1", "kind": "data", "label": "\"صيغ الإدخال والإخراج وتواقيع الأدوات\"", "line": [386, 70, 386, 201], "lx": 386, "ly": 112}, {"src": "L1", "dst": "L2", "kind": "data", "curve": [[400, 279], [418, 325], [418, 325], [418, 379]]}, {"src": "L2", "dst": "L3", "kind": "data", "line": [418, 441, 418, 527]}, {"src": "L1", "dst": "ENV", "kind": "data", "label": "\"طبقة التنفيذ\"", "curve": [[370, 279], [351, 325], [351, 325], [215, 375]], "off": "50%"}]});
    const ensureD3 = (cb) => {
