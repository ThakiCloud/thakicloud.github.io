...
```mermaid
flowchart TB
    LLM["محرك الاستدلال LLM"] -->|"صيغ الإدخال والإخراج وتواقيع الأدوات"| L1
    subgraph HARNESS["الكود كتجهيز للعامل"]
        direction TB
        L1["الطبقة 1 واجهة التجهيز<br/>تعريف ثنائي الاتجاه بين النموذج والبيئة"]
        L2["الطبقة 2 آلية التجهيز<br/>التخطيط والتحكم التكيفي"]
        L3["الطبقة 3 تنسيق العملاء المتعددين<br/>التوزيع والتجميع وإدارة التبعيات"]
        L1 --> L2 --> L3
    end
    L1 -->|"طبقة التنفيذ"| ENV["البيئة<br/>نظام الملفات وواجهات البرمجة وقواعد البيانات"]
```
