...
![نسبة أخذ العينات مقابل التكلفة النسبية بحسب نموذج التكلفة التحليلي (المعادلة 8)]({{ '/assets/images/posts/research/atomic-binary-judge-eval-service/fig1_cost_frontier.png' | relative_url }})
...
![رسم مفاهيمي لمعدل استخدام المستأجر مقابل زمن الانتظار المتوقع في الطابور (الافتراض 3)]({{ '/assets/images/posts/research/atomic-binary-judge-eval-service/fig2_latency_bound.png' | relative_url }})
...
![الشروط التي يقلّل عندها تفكيك المعايير من التباين]({{ '/assets/images/posts/research/atomic-binary-judge-eval-service/fig3_variance_reduction.png' | relative_url }})
