...
toc_sticky: true
lang: ar
canonical_url: "https://thakicloud.com/tech-blog/ar/research/paddleocr-vl-09b-multilingual-document-parsing/"
reading_time: true
header:
...
![تصوير مجرد يوضح تحول المستندات الشفافة إلى شبكة منظمة من العقد]({{ '/assets/images/paddleocr-vl-09b-multilingual-document-parsing-hero.webp' | relative_url }})
...
![مخطط توضيحي لخط أنابيب PaddleOCR-VL ثنائي المراحل]({{ '/assets/images/paddleocr-vl-09b-multilingual-document-parsing-diagram.webp' | relative_url }})
...
اللافت أن النموذج التقط العنوان الإنجليزي بوصفه ترويساً في Markdown (`##`)، وتعرّف بدقة على الجملة الكورية "다키클라우드 멀티테넌트 추론 비용 보고서"، وقرأ الأرقام والرموز النقدية ($9,640.00، GPU hours 1,284) دون أخطاء. جودة التعرف على الكورية مستقرة بشكل لافت لنموذج بهذا الحجم.
...
![مخطط مسافة التحرير لتعرف PaddleOCR-VL على النص متعدد اللغات]({{ '/assets/images/paddleocr-vl-09b-multilingual-document-parsing-results.webp' | relative_url }})
...
![مخطط مقارنة الدرجات الإجمالية على OmniDocBench v1.5]({{ '/assets/images/paddleocr-vl-09b-multilingual-document-parsing-bench.webp' | relative_url }})
