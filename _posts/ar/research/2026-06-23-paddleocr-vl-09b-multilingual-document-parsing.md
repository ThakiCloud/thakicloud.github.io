...
![مخطط توضيحي لخط أنابيب PaddleOCR-VL ثنائي المراحل](/assets/images/paddleocr-vl-09b-multilingual-document-parsing-diagram.webp)
...
![مخطط مسافة التحرير لتعرف PaddleOCR-VL على النص متعدد اللغات](/assets/images/paddleocr-vl-09b-multilingual-document-parsing-results.webp)
...
![مخطط مقارنة الدرجات الإجمالية على OmniDocBench v1.5](/assets/images/paddleocr-vl-09b-multilingual-document-parsing-bench.webp)
