...
toc_icon: "cog"
toc_sticky: true
canonical_url: "https://thakicloud.com/tech-blog/ar/research/asktoact-llm-tool-use-self-correcting-clarification/"
reading_time: true
lang: ar
published: false
categories:
...
```mermaid
graph TD
    A["مجموعة بيانات تعلم الأدوات الموجودة"] --> B["تحديد المعاملات وتقييم الأهمية"]
    B --> C["الحذف الانتقائي للمعاملات الجوهرية"]
    C --> D["توليد الاستفسارات غير المحددة"]
    
    D --> E["تحليل المهام"]
    E --> F["توليد أسئلة التوضيح"]
    F --> G["تجميع الحوار متعدد الأدوار"]
    
    G --> H["مجموعة بيانات التوضيح الأساسية"]
    H --> I["توليد أزواج الخطأ والتصحيح"]
    I --> J["4 أنواع من الأخطاء<br/>• أسئلة مكررة<br/>• أسئلة غير ذات صلة<br/>• أسئلة محذوفة<br/>• تفسير غير دقيق"]
    
    J --> K["تعزيز بيانات أزواج الخطأ والتصحيح"]
    H --> L["بيانات الحوار الأصلية"]
    K --> M["مجموعة البيانات التدريبية المتكاملة"]
    L --> M
    
    M --> N["تطبيق الإخفاء الانتقائي"]
    N --> O["دور الخطأ: استثناء حساب الخسارة"]
    N --> P["دور التصحيح: تعلم طبيعي"]
    
    O --> Q["الضبط الدقيق القائم على LoRA"]
    P --> Q
    Q --> R["نموذج AskToAct"]
    
    R --> S["الحوار في الوقت الفعلي"]
    S --> T["توضيح النية"]
    T --> U["آلية التصحيح الذاتي"]
    U --> V["استدعاء دقيق للأدوات"]
