...
<script>
  (() => {
    const SPEC = ({"title": "", "ariaLabel": "", "width": 268, "height": 742, "legendTitle": "Legend", "legend": {"data": "Flow", "event": "Dotted / alternate path"}, "hint": "Hover a node to trace its connections.", "groups": [], "nodes": [{"id": "A", "x": 24, "y": 24, "w": 212, "h": 94, "title": ["1. قاعدة LLM", "المحوّل · نظام GPU", "SFT · LoRA · MoE · الضغط ·", "تحسين الاستدلال"]}, {"id": "B", "x": 35, "y": 196, "w": 191, "h": 94, "title": ["2. المحاذاة والاستدلال", "RLHF · PPO · DPO · GRPO", "نمذجة المكافأة · CoT ·", "التوسع في وقت الاختبار"]}, {"id": "C", "x": 31, "y": 382, "w": 198, "h": 126, "title": ["3. نظام العوامل", "RL القائم على المسارات ·", "RAG / Agentic RAG", "الذاكرة · MCP ·", "المهارات/الأدوات · A2A ·", "متعدد العوامل"]}, {"id": "D", "x": 31, "y": 600, "w": 198, "h": 110, "title": ["4. النشر والتقييم", "إطار عمل العوامل · واجهة", "مستخدم العوامل", "منهجية التقييم · النشر", "الإنتاجي"]}], "edges": [{"src": "A", "dst": "B", "kind": "data", "line": [130, 118, 130, 196]}, {"src": "B", "dst": "C", "kind": "data", "curve": [[150, 290], [170, 336], [170, 336], [153, 382]]}, {"src": "C", "dst": "D", "kind": "data", "curve": [[146, 508], [158, 554], [158, 554], [145, 600]]}, {"src": "D", "dst": "C", "kind": "event", "label": "تغذية راجعة", "curve": [[115, 600], [102, 554], [102, 554], [114, 508]], "off": "50%"}, {"src": "C", "dst": "B", "kind": "event", "label": "إشارة إعادة التدريب", "curve": [[107, 382], [90, 336], [90, 336], [110, 290]], "off": "50%"}]});
    const ensureD3 = (cb) => {
