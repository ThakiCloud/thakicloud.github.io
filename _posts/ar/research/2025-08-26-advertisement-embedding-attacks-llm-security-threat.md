...
![نموذج تهديد هجمات تضمين الإعلانات (AEA): نواقل الهجوم، نموذج LLM المُخترَق، المخرجات المحقونة بالإعلانات، وطبقة الدفاع]({{ '/assets/images/advertisement-embedding-attacks-diagram.svg' | relative_url }})
