...
![صورة تجريدية لمنحنى تحجيم يرتفع فوق أساس من التدريب المسبق](/assets/images/reasoning-pretraining-to-post-training-hero.webp)
...
<script>
  (() => {
    const SPEC = ({"title": "", "ariaLabel": "", "width": 382, "height": 584, "legendTitle": "Legend", "legend": {"data": "Flow", "event": "Dotted / alternate path"}, "hint": "Hover a node to trace its connections.", "groups": [], "nodes": [{"id": "Pre", "x": 96, "y": 24, "w": 163, "h": 78, "title": ["التدريب المسبق", "مباريات شطرنج بشرية", "5M-1B معامل"]}, {"id": "SFT", "x": 152, "y": 180, "w": 191, "h": 62, "title": ["الضبط الدقيق الموجّه", "مسارات استدلال اصطناعية"]}, {"id": "RL", "x": 145, "y": 334, "w": 205, "h": 78, "title": ["التعلم المعزز", "ألغاز شطرنج، مكافأة قابلة", "للتحقق"]}, {"id": "Eval", "x": 113, "y": 490, "w": 128, "h": 62, "title": ["التقييم", "دقة حل الألغاز"]}], "edges": [{"src": "Pre", "dst": "SFT", "kind": "data", "curve": [[212, 102], [247, 141], [247, 141], [247, 180]]}, {"src": "SFT", "dst": "RL", "kind": "data", "line": [247, 242, 247, 334]}, {"src": "RL", "dst": "Eval", "kind": "data", "curve": [[247, 412], [247, 451], [247, 451], [208, 490]]}, {"src": "Pre", "dst": "Eval", "kind": "event", "label": "خسارة التدريب المسبق تتنبأ", "curve": [[142, 102], [107, 211], [107, 373], [146, 490]], "off": "50%"}]});
    const ensureD3 = (cb) => {
