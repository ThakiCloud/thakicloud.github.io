...
![حدود باريتو بين MTTR والأمان]({{ '/assets/images/posts/research/safe-autonomy-k8s-remediation/pareto-frontier.png' | relative_url }})
...
![تقليل MTTR حسب نوع الحادثة تحت سقف أمان 2 بالمئة]({{ '/assets/images/posts/research/safe-autonomy-k8s-remediation/per-type-mttr-reduction.png' | relative_url }})
