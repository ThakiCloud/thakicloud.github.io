...
![صورة تجريدية للوح زجاجي شبه شفّاف يمرّ شريط ضوئي في داخله بينما تبقى أسطحه الخارجية بلا علامة](/assets/images/invisible-reasoning-filler-tokens-hero.png)
...
![رسم بياني شريطي لفروق الدقّة الناتجة عن رموز الحشو لدى 13 نموذجًا من الجدول 1، مقسّمًا بين مهمّتَي الحساب والضرب](/assets/images/invisible-reasoning-filler-tokens-results.png)
