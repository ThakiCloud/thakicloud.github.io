...
![رسم تجريدي لثلاثة مدارات تدور حول فكرة واحدة]({{ '/assets/images/gpt-5-6-sol-terra-luna-hero.png' | relative_url }})
...
![مقارنة أسعار الإدخال والإخراج لكل مليون رمز بين الفئات]({{ '/assets/images/gpt-5-6-sol-terra-luna-results.png' | relative_url }})
