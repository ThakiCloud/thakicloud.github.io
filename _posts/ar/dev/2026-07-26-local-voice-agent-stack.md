...
![رسوم بيانية لزمن الاستجابة المقيس لكل مرحلة في الحلقة الصوتية المحلية ومقارنة مساري الدفعات]({{ '/assets/images/local-voice-agent-stack-results.webp' | relative_url }})
