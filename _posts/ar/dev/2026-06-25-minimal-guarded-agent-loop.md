...
![حلقة الوكيل مع ضوابط الحماية: بعد قرار السياسة، يجب على الحلقة اجتياز حد الخطوات وميزانية الوقت وكشف التكرار قبل تنفيذ أي أداة. وإذا أُطلق أي ضابط حماية، توقف الحلقة بسبب إنهاء صريح](/assets/images/minimal-guarded-agent-loop-diagram.webp)
...
![عدد خطوات الحلقة لكل مهمة وتوزيع أسباب الإنهاء: أربع مهام تنتهي بصورة طبيعية في 1 إلى 2 خطوة، ومهمة فخ التكرار الوحيدة تتوقف عبر كشف التكرار](/assets/images/minimal-guarded-agent-loop-results.webp)
