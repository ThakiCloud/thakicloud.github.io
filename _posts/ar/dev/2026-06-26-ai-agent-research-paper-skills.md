...
toc_sticky: true
lang: ar
canonical_url: "https://thakicloud.com/tech-blog/ar/dev/ai-agent-research-paper-skills/"
reading_time: true
categories:
  - dev
---
...
![صورة مجردة تُظهر وحدة معرفية مركزية تتفرع منها ثلاثة تدفقات بيانات نحو ثلاثة أدوات مختلفة]({{ '/assets/images/ai-agent-research-paper-skills-hero.webp' | relative_url }})
...
![هيكل يُظهر حزمة Skill واحدة قابلة للنقل تحتوي على ملف SKILL.md ومواد مرجعية، مُدمجة بالتساوي في ثلاثة harness: Claude Code وCodex وGemini، لتنفيذ مهام كتابة الأوراق البحثية]({{ '/assets/images/ai-agent-research-paper-skills-diagram.webp' | relative_url }})
