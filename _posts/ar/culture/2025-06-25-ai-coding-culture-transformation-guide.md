...
وفقاً لتقرير GitHub Octoverse 2024، يستخدم ثلاثة وسبعون بالمائة من المشاركين في استطلاع المصادر المفتوحة أدوات البرمجة بالذكاء الاصطناعي، وأظهر استطلاع JetBrains للمطورين 2024 أن 69% من المستجيبين جربوا ChatGPT وأن 49% يستخدمونه بانتظام. لقد أصبحت البرمجة بالذكاء الاصطناعي مهارة أساسية وليس خياراً.

المسألة ليست ما إذا كنا سنستخدم الذكاء الاصطناعي أم لا، بل كيف نستخدمه بفعالية. صاغ Andrej Karpathy مصطلح "vibe coding" في فبراير 2025، ثم قدّمت دراسة على arXiv (2505.19443) مقارنةً منهجية بين البرمجة الإيقاعية والبرمجة الوكيلة بوصفهما محورين مستقلين لاستخدام الذكاء الاصطناعي. دعونا نستكشف كيفية بناء ثقافة تطوير مناسبة لهذا العصر الجديد.
...
الإحصائيات الحالية ترسم صورة مختلفة عن الافتراضات الشائعة. يُظهر GitHub Octoverse 2024 استخدام أدوات البرمجة بالذكاء الاصطناعي من قِبل 73% من المشاركين في استطلاع المصادر المفتوحة، ويُشير استطلاع JetBrains Developer Survey 2024 إلى أن 69% من المستجيبين جربوا ChatGPT وأن 49% يستخدمونه بانتظام، بينما يبقى تدهور الجودة من أدوات الذكاء الاصطناعي غير مؤكد وفقاً لتحليل جودة GitHub. تُظهر دراسات بحثية متعددة تحسينات متوسطة في سرعة التطوير تتراوح بين خمسة وثلاثين إلى خمسين بالمائة.
...
الثقافة الجديدة تبدأ ليس بالإعلانات الكبرى بل بالممارسات الصغيرة. استناداً إلى نموذجي البرمجة الإيقاعية والبرمجة الوكيلة - اللذين صاغهما Andrej Karpathy وقارنتهما منهجياً دراسة arXiv:2505.19443 - كونوا رواد عصر البرمجة بالذكاء الاصطناعي واعملوا معاً لإنشاء ثقافات تطوير أكثر إبداعاً وإنتاجية ومتعة.

## المراجع

- [GitHub Octoverse 2024](https://github.blog/news-insights/octoverse/octoverse-2024/) - 73% من المشاركين في استطلاع المصادر المفتوحة يستخدمون أدوات البرمجة بالذكاء الاصطناعي
- [JetBrains State of Developer Ecosystem 2024](https://www.jetbrains.com/lp/devecosystem-2024/) - واقع استخدام أدوات الذكاء الاصطناعي بين المطورين
- [Vibe Coding vs. Agentic Coding (arXiv:2505.19443)](https://arxiv.org/abs/2505.19443) - مقارنة منهجية بين النموذجين
- [Andrej Karpathy، منشور "vibe coding" الأصلي (2025-02)](https://x.com/karpathy/status/1886192184808149383)
