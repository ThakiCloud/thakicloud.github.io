...
![fable-advisor: سير عمل متعدد الموردين يقوده Fable 5 وينفذه Grok 4.5 개념을 형상화한 이미지](/assets/images/fable-advisor-multi-model-orchestration-hero.png)
*글의 핵심 개념을 형상화했습니다.*
...
<!-- nlm-visual -->
![핵심 개념 요약 인포그래픽 1](/assets/images/posts/news/fable-advisor-multi-model-orchestration/nlm-infographic-1.png)
...
<!-- nlm-visual -->
![핵심 개념 요약 인포그래픽 2](/assets/images/posts/news/fable-advisor-multi-model-orchestration/nlm-infographic-2.png)
*NotebookLM이 소스를 종합해 생성한 인포그래픽입니다.*
