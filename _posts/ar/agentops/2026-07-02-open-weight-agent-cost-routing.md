...
toc_sticky: true
lang: ar
canonical_url: "https://thakicloud.github.io/ar/agentops/open-weight-agent-cost-routing/"
reading_time: true
header:
...
![مخطط مقارنة تكلفة API الشهرية حسب الفئة](/assets/images/open-weight-agent-cost-routing-results.webp)
