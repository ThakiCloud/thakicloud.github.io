...
![صورة تجريدية تصوّر وكيلا يكتسب البصر بينما تتدفق إطارات الفيديو وموجات الصوت نحو عدسة واحدة]({{ '/assets/images/claude-video-agent-watch-hero.webp' | relative_url }})
