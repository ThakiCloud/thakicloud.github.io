...
![بنية تنسيق Sakana Fugu: خلف واجهة برمجية واحدة، يُنسق Fugu ديناميكيًا مجموعة وكلاء]({{ '/assets/images/sakana-fugu-orchestration-model-diagram.webp' | relative_url }})
