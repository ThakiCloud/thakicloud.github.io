...
![كيف تبني مهارة Claude Code صفحات هبوط احترافية بضربة واحدة 개념을 형상화한 이미지](/assets/images/claude-code-skill-oneshot-landing-pages-hero.webp)
*글의 핵심 개념을 형상화했습니다.*
...
<!-- nlm-visual -->
![핵심 개념 요약 인포그래픽 1](/assets/images/posts/news/claude-code-skill-oneshot-landing-pages/nlm-infographic-1.webp)
...
<!-- nlm-visual -->
![핵심 개념 요약 인포그래픽 2](/assets/images/posts/news/claude-code-skill-oneshot-landing-pages/nlm-infographic-2.webp)
*NotebookLM이 소스를 종합해 생성한 인포그래픽입니다.*
