...
audiobook: "https://drive.google.com/file/d/1LJvaYzSNywGVfMKKL7Z5PEwcsiZOm7bs/view"
...
عند استخدام عوامل البرمجة (coding agents) ضمن فريق، نصطدم بجدار غريب. العامل ملك لي وحدي. حتى لو كان زميلي في المكتب المجاور يعمل على المستودع نفسه، فإن كل Claude لا يعرف بوجود الآخر. البشر يتعاونون عبر Slack ومشاركة الشاشة، بينما العوامل التي تعدّل الكود نيابة عنا محبوسة كل واحدة في جزيرتها الخاصة. أداة **Claude Code متعدد اللاعبين** التي كُشف عنها مؤخراً وأثارت ضجة تستهدف هذا الجدار بالتحديد. إنها تجربة تتيح لعدة أشخاص استخدام الطرفية (terminal) نفسها معاً، وربط كل Claude بالآخر بحيث تتحدث العوامل فيما بينها. بالنسبة إلى من يتبنى عوامل البرمجة على مستوى الفريق، يمكن هنا استشراف مشكلات التعارض والصلاحيات والتدقيق التي تظهر بمجرد ربط العوامل ببعضها.

![عندما تبدأ عوامل البرمجة بالتحدث مع بعضها البعض: تصميم Claude Code متعدد اللاعبين وعوامل التعاون 개념을 형상화한 이미지](/assets/images/claude-code-multiplayer-collaborative-agents-hero.webp)
*글의 핵심 개념을 형상화했습니다.*
...
<!-- nlm-visual -->
![핵심 개념 요약 인포그래픽 1](/assets/images/posts/news/claude-code-multiplayer-collaborative-agents/nlm-infographic-1.webp)
...
<!-- nlm-visual -->
![핵심 개념 요약 인포그래픽 2](/assets/images/posts/news/claude-code-multiplayer-collaborative-agents/nlm-infographic-2.webp)
*NotebookLM이 소스를 종합해 생성한 인포그래픽입니다.*
