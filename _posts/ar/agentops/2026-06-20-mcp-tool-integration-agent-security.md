...
![رسم لبنية أمنية تعالج فيها بوابة MCP المصادقة وقائمة الأدوات المسموح بها وتسجيل التدقيق وتحديد المعدل مركزياً قبل توجيه الطلبات إلى خوادم MCP الخاصة بـ GitHub وSlack وقاعدة البيانات](/assets/images/mcp-tool-integration-agent-security-diagram.png)
