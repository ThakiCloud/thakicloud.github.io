...
canonical_url: "https://thakicloud.com/tech-blog/ar/careers/beyond-technical-skills-career-growth-strategy-ar/"
categories:
  - careers
---
...
![رسم توضيحي يُظهر المهارة التقنية كأساس، وثلاثة مبادئ هي التفكير في المنتج وتنفيذ المشروع ومهارات التعامل مع الآخرين ترتفع فوقه، وتتقارب معًا في إنجاز ذو معنى، تقودها الوكالة مع حلقة تغذية راجعة تُصلح أضعف حلقة أولاً]({{ '/assets/images/beyond-technical-skills-career-growth-strategy-diagram-ar.svg' | relative_url }})
